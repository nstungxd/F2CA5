<div id="content" class="ninecol last">
        ...
        <div class="panel">
            <div class="content">
                <table class='register' style="background: #F7F7F7;">
                    <tbody>
                    <tr>
                        <td><label for="pro1" id="labelpro1">Center<span class="regdot"></span></label></td>
                        <td><?php echo $center->CenterNm ?></td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        {
            $.post("<?php echo $baseDir; ?>/admin/cassign/calendar_center", {
                seq:seq,
                mnth : mnth,
                yrs : yrs
            }, function(data) {
        ...
        function changeColor(rownum,cellnum,days,month,year)
        {
            ...
            if(a.attr("class") == 'info')
            {
                ...
                var wo = $("#workout").val();
                $.post("<?php echo $baseDir; ?>/admin/cassign/add_center", {
                    wo:wo,
                    seq:seq,
                    days : days,
                    mnth : month,
            ...
            {
                $.post("<?php echo $baseDir; ?>/admin/cassign/remove_center", {
                    seq:seq,
                    days : days,
                    mnth : month,
                    yrs : year
