...
<script type='text/javascript'>
    ...
    function doSearch(page)
    {
        ...
        $.post("<?php echo $baseDir; ?>/admin/cassign/search_member", {
                page : page,
                keyvalue : keyvalue,
    ...
    function onAssignMember(seq)
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/cassign/member?seq=' + seq + '&page=' + cpage;
    }
	function onAssignDefault(seq)
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/cassign/memberdefault?seq=' + seq + '&page=' + cpage;
    }
