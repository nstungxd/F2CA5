<div id="content" class="ninecol last">
        ...
        <div class="panel">
            <div class="content">
                <table class='register' style="background: #F7F7F7;">
                    <tbody>
                    <tr>
                        <td><label for="pro1" id="labelpro1">Member<span class="regdot"></span></label></td>
                        <td><?php echo $user->UserNm ?></td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        {
            $.post("<?php echo $baseDir; ?>/admin/cassign/calendar_member", {
                seq:seq,
                mnth : mnth,
                yrs : yrs
            }, function(data) {
        ...
        function changeColor(rownum,cellnum,days,month,year)
        {
            ...
            if(a.attr("class") == 'info')
            {
                ...
                var wo = $("#workout").val();
                $.post("<?php echo $baseDir; ?>/admin/cassign/add_member", {
                    wo:wo,
                    seq:seq,
                    days : days,
                    mnth : month,
            ...
            {
                $.post("<?php echo $baseDir; ?>/admin/cassign/remove_member", {
                    seq:seq,
                    days : days,
                    mnth : month,
                    yrs : year
