<div id="content" class="ninecol last">
    <div class="panel-wrapper">
        <div class="panel">
            <div class="title no-border">
                ...
                <div class="headline first" style="float:right">
                    <button class="button-green" onclick="onAdd();">Add Value</button>
                </div>
            </div>
            <div class="content">
                <div id="tbl-data"></div>
        ...
        function doSearch(page)
        {
            ...
            $.post("<?php echo $baseDir; ?>/admin/ccategory/search_category_member", {
                page : page,
                seq : seq,
                keyvalue : keyvalue
            }, function(data) {
        ...
        function onDelete(seq)
        {
            if (confirm("Are you sure to delete this?")) {
                $.post("<?php echo $baseDir; ?>/admin/ccategory/delete_member_category", {
                    seq : seq
                }, function(data) {
                    if(data!='') alert(data);
                    doSearch(0);
        ...
        function onAdd()
        {
            window.location.href = '<?php echo $baseDir; ?>/admin/ccategory/add_member_category?page=' + cpage +'&seq=' + seq;
        }
