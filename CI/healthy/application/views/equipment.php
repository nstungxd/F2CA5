...
<script type='text/javascript'>
    ...
    function doSearch(page)
    {
        ...
        $.post("<?php echo $baseDir; ?>/admin/cequipment/search_equipment", {
                page : page,
                keyvalue : keyvalue,
    ...
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/cequipment/equipmentmodify?seq='+seq+'&page=' + cpage;
    }

    function onDelete(seq)
    {
        if (confirm("Are you sure to delete this?")) {
            $.post("<?php echo $baseDir; ?>/admin/cequipment/delete_equipment", {
                    seq : seq
                }, function(data) {
                    doSearch(0);
            });
