...
<script type='text/javascript'>
    ...
    function doSearch(page)
    {
        ...
        $.post("<?php echo $baseDir; ?>/admin/common/search_extarget", {
                page : page,
                keyvalue : keyvalue
            }, function(data) {
    ...
    function onAdd()
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/common/extargetregister?page=' + cpage;
    }

    function onModify(seq)
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/common/extargetmodify?seq='+seq+'&page=' + cpage;
    }

    function onDelete(seq)
    {
        if (confirm("Are you sure to delete this?")) {
            $.post("<?php echo $baseDir; ?>/admin/common/delete_extarget", {
                    seq : seq
                }, function(data) {
                    doSearch(0);
            });
