...
<script type='text/javascript'>
    ...
    function doSearch(page)
    {
        ...
        $.post("<?php echo $baseDir; ?>/admin/common/search_food", {
                page : page,
                keyvalue : keyvalue
            }, function(data) {
    ...
    function onAdd()
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/common/foodregister?page=' + cpage;
    }

    function onModify(seq)
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/common/foodmodify?seq='+seq+'&page=' + cpage;
    }

    function onDelete(seq)
    {
        if (confirm("Are you sure to delete this?")) {
            $.post("<?php echo $baseDir; ?>/admin/common/delete_food", {
                    seq : seq
                }, function(data) {
                    doSearch(0);
            });
