<div id="content" class="ninecol last">
        ...
        <div class="panel">
            <div class="title no-border">
                ...
                <div class="headline first" style="float:right">
                    <button class="button-green" onclick="onAdd();">Add new Group</button>
                </div>
            </div>
            <div class="content">
                <div id="tbl-data"></div>
    ...
    <script type='text/javascript'>
        ...
        function doSearch(page)
        {
            ...
            $.post("<?php echo $baseDir; ?>/admin/cgroup/search_group", {
                page : page,
                keyvalue : keyvalue,
        ...
        {
            window.location.href = '<?php echo $baseDir; ?>/admin/cgroup/groupmodify?seq='+seq+'&page=' + cpage;
        }
        function onAdd()
        {
            window.location.href = '<?php echo $baseDir; ?>/admin/cgroup/groupregister?page=' + cpage;
        }

        function onDelete(seq)
        {
            if (confirm("Are you sure to delete this?")) {
                $.post("<?php echo $baseDir; ?>/admin/cgroup/delete_group", {
                    seq : seq
                }, function(data) {
                    if(data!='') alert(data);
                    doSearch(0);
        ...
        {
             window.location.href = '<?php echo $baseDir; ?>/admin/cgroup/details?seq=' + seq + '&page=' + cpage;
        }
