...
<script type='text/javascript'>
    ...
    function doSearch(page)
    {
        ...
        $.post("<?php echo $baseDir; ?>/admin/cmember/search_member", {
                page : page,
                keyvalue : keyvalue,
    ...
    {
        window.location.href = '<?php echo $baseDir; ?>/admin/cmember/membermodify?seq='+seq+'&page=' + cpage;
    }

    function onDelete(seq)
    {
        if (confirm("Are you sure to delete this?")) {
            $.post("<?php echo $baseDir; ?>/admin/cmember/delete_member", {
                    seq : seq
                }, function(data) {
                    doSearch(0);
            });
