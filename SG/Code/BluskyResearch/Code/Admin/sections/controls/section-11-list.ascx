<%@ Control Language="VB" AutoEventWireup="false"   Inherits="AdminSection11List" CodeFile="section-11-list.ascx.vb" %>
...
<header>
<h3>A Relationships List</h3>
   <% if CanAdd then %>
       <asp:linkbutton runat='Server' id='add_new_link1' CssClass='admin_links btn_addnew' onCommand='AddNew'>New Relationship</asp:linkbutton>
       <% if HasParent then %>
...
<MasterTableView DataKeyNames="admin_section_relationship_id"> 
<Columns> 
<telerik:GridBoundColumn ItemStyle-CssClass='css_admin_section_relationship_type' SortExpression='admin_section_relationship_type' HeaderText='Type' DataField='admin_section_relationship_type'   />
<telerik:GridBoundColumn ItemStyle-CssClass='css_admin_section_relationship_name' SortExpression='admin_section_relationship_name' HeaderText='Name' DataField='admin_section_relationship_name'   />
