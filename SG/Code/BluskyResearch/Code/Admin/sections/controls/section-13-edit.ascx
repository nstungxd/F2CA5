<%@ Control autoeventwireup="false" Language="VB"  CodeFile="section-13-edit.ascx.vb" Inherits="AdminSection13Edit"  %>
...
<OtherSections:AddNewSection12 ID="input_admin_custom_link_section_AddEdit"  Visible="false" runat="server" />
...
<fieldset><div id='panel_1_group_2' class="g_admin_panel">
      <label>General</label>
       ...
       <div class="admin_form_row clearfix" id="edit_column_admin_custom_link_section"  >
  <span class="admin_form_title"> Section</span>
<asp:textbox runat='server' visible='false' id='prechanges_admin_custom_link_section' />



<PingCore:DependentDropdown id="input_admin_custom_link_section" runat="server"   />
</div>

       <div class="admin_form_row clearfix" id="edit_column_admin_custom_link_url"  >
  <span class="admin_form_title"> Url</span>
<asp:textbox runat='server' visible='false' id='prechanges_admin_custom_link_url' />



<asp:TextBox  width='320'  MaxLength='200'  ID="input_admin_custom_link_url"  CssClass="formCopy admin_form_text" runat="server"   />
</div>

       <div class="admin_form_row clearfix" id="edit_column_admin_custom_link_name"  >
  <span class="admin_form_title"> Name</span>
<asp:textbox runat='server' visible='false' id='prechanges_admin_custom_link_name' />



<asp:TextBox  width='320'  MaxLength='200'  ID="input_admin_custom_link_name"  CssClass="formCopy admin_form_text" runat="server"   />
</div>

       <div class="admin_form_row clearfix" id="edit_column_admin_custom_link_isfunction"  >
  <span class="admin_form_title"> Is Function?</span>
<asp:textbox runat='server' visible='false' id='prechanges_admin_custom_link_isfunction' />



<asp:checkbox runat="Server" ID="input_admin_custom_link_isfunction"   CssClass="admin_form_check" />
</div>

       <div class="admin_form_row clearfix" id="edit_column_admin_custom_link_new_win"  >
  <span class="admin_form_title"> Open in new window</span>
<asp:textbox runat='server' visible='false' id='prechanges_admin_custom_link_new_win' />



<asp:checkbox runat="Server" ID="input_admin_custom_link_new_win"   CssClass="admin_form_check" />
</div>
