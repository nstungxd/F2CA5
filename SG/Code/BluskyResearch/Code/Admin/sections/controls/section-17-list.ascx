<%@ Control Language="VB" AutoEventWireup="false"   Inherits="AdminSection17List" CodeFile="section-17-list.ascx.vb" %>
...
<header>
<h3>A Image Sizes List</h3>
   <% if CanAdd then %>
       <asp:linkbutton runat='Server' id='add_new_link1' CssClass='admin_links btn_addnew' onCommand='AddNew'>New Image Size</asp:linkbutton>
       <% if HasParent then %>
...
<MasterTableView DataKeyNames="image_size_id"> 
<Columns> 
<telerik:GridBoundColumn ItemStyle-CssClass='css_max_width' SortExpression='max_width' HeaderText='Max Width' DataField='max_width'   />
