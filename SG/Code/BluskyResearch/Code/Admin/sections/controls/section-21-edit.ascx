<%@ Control autoeventwireup="false" Language="VB"  CodeFile="section-21-edit.ascx.vb" Inherits="AdminSection21Edit"  %>
...
<fieldset><div id='panel_1_group_2' class="g_admin_panel">
      <label>General</label>
       ...
       <div class="admin_form_row clearfix" id="edit_column_field_group_name"  >
  <span class="admin_form_title"> Name</span>
<asp:textbox runat='server' visible='false' id='prechanges_field_group_name' />



<asp:TextBox  width='320'  MaxLength='100'  ID="input_field_group_name"  CssClass="formCopy admin_form_text" runat="server"   />
</div>

       <div class="admin_form_row clearfix" id="edit_column_field_group_MaxAuthority"  >
  <span class="admin_form_title"> Max Authority</span>
<asp:textbox runat='server' visible='false' id='prechanges_field_group_MaxAuthority' />



<asp:TextBox  width='320'  ID="input_field_group_MaxAuthority"  CssClass="formCopy admin_form_text" runat="server"   />
     <asp:RegularExpressionValidator SetFocusOnError="true" ForeColor="#7B040F" ErrorMessage='Max Authority'  runat="server" id="reqEx_field_group_MaxAuthority"  ControlToValidate="input_field_group_MaxAuthority" Text="This entry is invalid" Display="Dynamic" ValidationExpression="^[0-9]{0,4}$" ></asp:RegularExpressionValidator>
</div>
