<%@ Control autoeventwireup="false" Language="VB"  CodeFile="section-29-edit.ascx.vb" Inherits="AdminSection29Edit"  %>
...
<fieldset><div id='panel_1_group_2' class="g_admin_panel">
      <label>General</label>
       ...
       <div class="admin_form_row clearfix" id="edit_column_utype_name"  >
  <span class="admin_form_title"> Name</span>
<asp:textbox runat='server' visible='false' id='prechanges_utype_name' />



<asp:TextBox  width='320'  MaxLength='50'  ID="input_utype_name"  CssClass="formCopy admin_form_text" runat="server"   />
</div>

       <div class="admin_form_row clearfix" id="edit_column_utype_hasglobalaccess"  >
  <span class="admin_form_title"> Hasglobalaccess</span>
<asp:textbox runat='server' visible='false' id='prechanges_utype_hasglobalaccess' />



<asp:checkbox runat="Server" ID="input_utype_hasglobalaccess"   CssClass="admin_form_check" />
</div>
