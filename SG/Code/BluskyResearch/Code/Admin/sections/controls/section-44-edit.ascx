<%@ Control autoeventwireup="false" Language="VB"  CodeFile="section-44-edit.ascx.vb" Inherits="AdminSection44Edit"  %>
...
<fieldset><div id='panel_1_group_2' class="g_admin_panel">
      <label>General</label>
       ...
       <div class="admin_form_row clearfix" id="edit_column_function_name"  >
  <span class="admin_form_title"> Name</span>
<asp:textbox runat='server' visible='false' id='prechanges_function_name' />



<asp:TextBox  width='320'  MaxLength='50'  ID="input_function_name"  CssClass="formCopy admin_form_text" runat="server"   />
</div>
