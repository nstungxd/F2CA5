<%@ Control Language="VB" AutoEventWireup="false"   Inherits="AdminSection46List" CodeFile="section-46-list.ascx.vb" %>
...
<header>
<h3>A Dropdown Translations List</h3>
   <% if CanAdd then %>
       <asp:linkbutton runat='Server' id='add_new_link1' CssClass='admin_links btn_addnew' onCommand='AddNew'>New Translation</asp:linkbutton>
       <% if HasParent then %>
...
<MasterTableView DataKeyNames="ddt_id"> 
<Columns> 
<telerik:GridBoundColumn ItemStyle-CssClass='css_ddt_id' SortExpression='ddt_id' HeaderText='ID' DataField='ddt_id'   />
<telerik:GridBoundColumn ItemStyle-CssClass='css_ddt_dropdownid' SortExpression='ddt_dropdownid' HeaderText='Dropdown' DataField='ddt_dropdownid'   />
<telerik:GridBoundColumn ItemStyle-CssClass='css_ddt_name' SortExpression='ddt_name' HeaderText='Name' DataField='ddt_name'   />
