...
Partial Class AdminSection55Edit
Inherits PingCore.Controls.AdminSectionEditControl
Private Const SectionID as integer = 55
...
'   End Property
 ...
 if intRecordID = 0 then: edittitle.Text = "Adding New Regex" : end if
       ...
       MyContent.PageContent.FocusFirstControl(pnl_edit)
		if intRecordID <>  0 then
			...
			Dim strSQL As String = "SELECT * FROM zz_admin_regular_expressions  WHERE  RegularExpressionID='" & PageContent.addSlashes(PrimaryKeyValue) & "'"
			Dim dt As DataTable = MyData.DBFactory.DB.GetDataTable(strSQL)
           Dim Row As DataRow = dt.Rows(0)
      
      
prechanges_regular_expression_name.Text = MyContent.PageContent.MakeStr(Row.Item("regular_expression_name"))
input_regular_expression_name.Text = MyContent.PageContent.MakeStr(Row.Item("regular_expression_name"))
      
prechanges_regular_expression_pattern.Text = MyContent.PageContent.MakeStr(Row.Item("regular_expression_pattern"))
input_regular_expression_pattern.Text = MyContent.PageContent.MakeStr(Row.Item("regular_expression_pattern"))
      
prechanges_regular_expression_error_message.Text = MyContent.PageContent.MakeStr(Row.Item("regular_expression_error_message"))
input_regular_expression_error_message.Text = MyContent.PageContent.MakeStr(Row.Item("regular_expression_error_message"))
           Row = Nothing
           dt = Nothing
		else
...
input_regular_expression_name.Text =  ""
      
input_regular_expression_pattern.Text =  ""
      
input_regular_expression_error_message.Text =  ""
		end if
		page1.Visible = True
		currpage.Text=1
...
' Add/Update info for field RegularExpressionID

' Add/Update info for field regular_expression_name
 strPageAddNewFields &= "regular_expression_name,"
 strPageAddNewValues &= "'" &  MyContent.PageContent.addSlashes(MyContent.PageContent.makeStr(input_regular_expression_name.Text)) & "',"

 strPageUpdateString &=  "regular_expression_name='" &  MyContent.PageContent.addSlashes(MyContent.PageContent.makeStr(input_regular_expression_name.Text)) & "',"

' Add/Update info for field regular_expression_pattern
 strPageAddNewFields &= "regular_expression_pattern,"
 strPageAddNewValues &= "'" &  MyContent.PageContent.addSlashes(MyContent.PageContent.makeStr(input_regular_expression_pattern.Text)) & "',"

 strPageUpdateString &=  "regular_expression_pattern='" &  MyContent.PageContent.addSlashes(MyContent.PageContent.makeStr(input_regular_expression_pattern.Text)) & "',"

' Add/Update info for field regular_expression_error_message
 strPageAddNewFields &= "regular_expression_error_message,"
 strPageAddNewValues &= "'" &  MyContent.PageContent.addSlashes(MyContent.PageContent.makeStr(input_regular_expression_error_message.Text)) & "',"

 strPageUpdateString &=  "regular_expression_error_message='" &  MyContent.PageContent.addSlashes(MyContent.PageContent.makeStr(input_regular_expression_error_message.Text)) & "',"
   ...
   strPageAddNewString = "INSERT INTO zz_admin_regular_expressions (" & strPageAddNewFields & ") values (" & strPageAddNewValues & ");"
	strPageUpdateString = "UPDATE zz_admin_regular_expressions SET " &  left(strPageUpdateString, len(strPageUpdateString )-1) & " WHERE  RegularExpressionID='" & PageContent.addSlashes(PrimaryKeyValue) & "'" & ";"    
