<%@ Page Language="VB" AutoEventWireup="false" CodeFile="multitext-details.aspx.vb" Inherits="Surveys_text_details" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel runat="server" ID="pnlTextValues" CssClass="si_modal_textvalues si_modal_multitextvalues">
            <div class="s_modal_inner clearfix">
                ...
                <div class="s_modal_body clearfix">
                    <div class="si_m_col_list">
                        <asp:Repeater runat="server" ID="rptRowTitles">
                            <HeaderTemplate>
                                    <div class="si_m_row">
                                        <div class="si_m_row_item si_m_row_item_left bold">Individual Result Set:</div>
                                        <div class="si_m_row_item si_m_row_data si_m_row_item_right bold">
                            </HeaderTemplate>
                            <ItemTemplate>
                                    <div runat="server" id="si_m_row_multiitem" class="si_m_row_multiitem"><span class="bold"><%# Eval("Value")%></span></div>
                            </ItemTemplate>
                            <FooterTemplate>
                                        </div>
                                    </div>
                        ...
                        <asp:ListView runat="server" ID="lvTextValues" ItemPlaceholderID="phTextAnswer">
                            ...
                            <ItemTemplate>    
                                <div class="si_m_row">
                                    <div class="si_m_row_item si_m_row_item_left bold">
                                        <a href='<%# FormatLink(Eval("CurrentResponseID")) %>' target="main" title="View Individual Result Set"><span><%# Eval("CurrentResponseID")%></span></a>
                                    </div>
                                    <div class="si_m_row_item si_m_row_data si_m_row_item_right">
                                        <asp:Repeater runat="server" ID="rptOptionAnswers" OnItemDataBound="rptOptionAnswers_ItemDataBound">
                                            <ItemTemplate>
                                                <div runat="server" id="si_m_row_multiitem" class="si_m_row_multiitem">
                                                    <%# Eval("AnswerValue")%>
                                                </div>
                                            </ItemTemplate>
                                        </asp:Repeater>
