							...
							.bind(
								...
								function(e, selectedDate, $td)
								{
                                                           if(s.el != null)
                                                           {
                                                              ...
                                                              this.dt = Date.fromString(this.dt).asString();
                                                              Date.format = s.df;
									...
									if (this.value == '') {
										controller.clearSelected();
                                                                      ...
                                                                      if (d)
                                                                      {
                                                                         ...
                                                                         {
                                                                           //Date.format = s.dtf;
                                                                           //var dt = Date.fromString(this.value);
		...
		DatePicker.prototype,
		{
			...
			display : function(eleAlignTo)
			{
				...
				if (c.inline) {
					...
					cssRules = {
						'top'	:	eleOffset.top + 25 + c.verticalOffset,
						'left'	:	eleOffset.left + c.horizontalOffset - 159
					};
