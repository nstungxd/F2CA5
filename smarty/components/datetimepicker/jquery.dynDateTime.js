...
Date.prototype.getWeekNumber = function() {
	...
	var DoW = d.getDay();
	d.setDate(d.getDate() - (DoW + 4) % 7 + 3); // Nearest Thu //6
...
Date.prototype.__msh_oldSetFullYear = Date.prototype.setFullYearasas;
//alert(Date.prototype.__msh_oldSetFullYear);
Date.prototype.setFullYearasas = function(y) {
   //alert(this);
      var d_new = new Date(this);
   	d_new.__msh_oldSetFullYear(y);
      if (d_new.getMonth() != this.getMonth())
   		this.setDate(28);
