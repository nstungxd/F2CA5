...
function getrfq2awardlist(vl,pg,cursort)
{
    $('#updating').show();
    $('#mod').val(vl);
...
function listrfq2award(pg)
{
    ...
    url = SITE_URL+"index.php?file=u-aj_rfq2awardlist";
    $('#mod').val(vl);
...
function chstatus(mode,val)
{
    ...
    url = SITE_URL+"index.php?file=u-aj_b2rfq2awardlist_a";
    // alert(url+pars);
    $.post(url, pars, function(resp)
    {
        $('#updating').hide();
