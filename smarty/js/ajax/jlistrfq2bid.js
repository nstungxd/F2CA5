...
function listrfq2bid(pg)
{
	...
	{
		pars += "&mod=srch"+"&buyer2="+$('#buyer2').val()+"&vRFQ2Code="+$.trim($('#vRFQ2Code').val())+"&amount="+$.trim($('#amount').val())+"&vInvoiceCode="+$.trim($('#vInvoiceCode').val())+"&buyer="+$.trim($('#buyer').val())+"&supplier="+$.trim($('#supplier').val())+"&eAuctionType="+$.trim($('#eAuctionType').val())+"&eBidCriteria="+$.trim($('#eBidCriteria').val())+"&dStartDate="+$.trim($('#dStartDate').val())+"&dEndDate="+$.trim($('#dEndDate').val())+"&product="+$.trim($('#product').val())+"&bestbid="+$.trim($('#bestbid').val())+"&eStatus="+$.trim($('#eStatus').val())+"";
	}
   ...
   if($('#cursorttype')) {
    ...
    pars += "&gmtoffset="+gmtoffset;
	url = SITE_URL+"index.php?file=u-aj_rfq2bidlist";
	$('#mod').val(vl);
