...
* GENERATION DATE:  30.04.2012
* CLASS FILE:       /var/www/B2B/libraries/classes/application/class.InvoiceDetailLine.php
...
*/
   ...
   function getJoinTableInfo($jtbl,$fields="*",$where="",$orderBy="",$groupBy="",$limit="",$pg="") {
      ...
      $sql =  "SELECT $fields FROM ".PRJ_DB_PREFIX."_invoice_detail_line $jtbl $cnt $limit";
		$row = $this->_obj->MySQLSelect($sql);
		if($pg=="yes")
		{
			$sql_count =  "SELECT Count(*) as tot FROM ".PRJ_DB_PREFIX."_invoice_detail_line $jtbl $cnt_count";
