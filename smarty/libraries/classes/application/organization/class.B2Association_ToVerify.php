...
*
* -------------------------------------------------------
* CLASSNAME:        B2Association_ToVerify
* GENERATION DATE:  09.02.2011
* CLASS FILE:       D:\wamp\www\nw\B2B/libraries/classes/application/class.B2Association_ToVerify.php
* FOR MYSQL TABLE:  b2b_buyer2_association_master_toverify
...
*/
	...
	function select($id)
	{
			if(($id > 0) && (trim($id) != ''))
			{
				$sql =  "SELECT * FROM ".PRJ_DB_PREFIX."_buyer2_association_master_toverify WHERE iVerifiedID = $id";
			} else {
				$sql =  "SELECT * FROM ".PRJ_DB_PREFIX."_buyer2_association_master_toverify WHERE iVerifiedID=$this->_iVerifiedID ";
		 }
...
*/
	...
	function delete($id)
	{
		 $sql = "DELETE FROM ".PRJ_DB_PREFIX."_buyer2_association_master_toverify WHERE iVerifiedID = $id";
...
*/
	...
	function insert()
	{
		 ...
		 $Data = array(
						 'iB2AssociationID'		=>	$this->_iB2AssociationID,
		 ...
		 $result = $this->_obj->MySQLQueryPerform(PRJ_DB_PREFIX."_buyer2_association_master_toverify",$Data,'insert');
		  return $result;
	}
...
*/
	...
	function update($where)
	{
		 ...
		 $result = $this->_obj->MySQLQueryPerform(PRJ_DB_PREFIX."_buyer2_association_master_toverify",$Data,'update',$where);
		  return $result;
   ...
   function getDetails($feild="*",$where="",$orderBy="",$groupBy="",$limit="")
	{
       ...
       $sql =  "SELECT $feild FROM ".PRJ_DB_PREFIX."_buyer2_association_master_toverify $cnt $limit";
		 $row =  $this->_obj->MySQLSelect($sql);
       return $row;
	}
   ...
   function getJoinTableInfo($jtbl,$fields="*",$where="",$orderBy="",$groupBy="",$limit="",$pg="") {
      ...
      $sql =  "SELECT $fields FROM ".PRJ_DB_PREFIX."_buyer2_association_master_toverify $jtbl $cnt $limit";
		$row = $this->_obj->MySQLSelect($sql);
		if($pg=="yes")
		{
			$sql_count =  "SELECT Count(*) as tot FROM ".PRJ_DB_PREFIX."_buyer2_association_master_toverify $jtbl $cnt_count";
