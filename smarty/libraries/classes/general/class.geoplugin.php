...
class geoPlugin {
   ...
   //var $host = 'http://www.geoplugin.net/currency_converter.gp?ip={IP}&base_currency={CURRENCY}';
...
function gp_convertIt()
{
   ...
   else
   {
      ...
      $("#gp_converted").html("<div style='padding:10px'>"+output.from.symbol+output.from.amount+" = "+output.to.symbol+output.to.amount+"<br /><br />Get your own <a href='http://www.geoplugin.com/' title='geolocation and currency converter by geoPlugin'>free currency converter</a></div>");
      });
   }
}
*/
