...
$rsts = $statusmasterObj->getDetails('iStatusID', " AND vForAuction LIKE '%RFQ2 Bid,%' AND vStatus_en='Rejected' ");
...
$where .= " AND r2bd.iStatusID=$rsts AND r2bd.eSaved!='Yes' AND r2bd.iBuyer2Id=$curORGID ";
// echo $where; exit;
