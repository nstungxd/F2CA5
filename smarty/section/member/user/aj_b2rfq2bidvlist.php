...
$csts = $statusmasterObj->getDetails('iStatusID', " AND vForAuction LIKE '%RFQ2 Bid,%' AND vStatus_en='Create' ");
...
$where .= " AND r2bd.iStatusID=$csts AND r2bd.eSaved!='Yes' AND r2bd.iBuyer2Id=$curORGID ";
// echo $where; exit;
// $where .= " AND rfq2.dStartDate<NOW() ";
$where .= " AND r2bd.eDelete!='Verified' ";
$fields = " DISTINCT r2bd.*, rfq2.*, ioh.iInvoiceID, IF(rfq2.eFrom='Invoice',ioh.vInvoiceCode,poh.vPOCode) as vInvoiceCode, IF(rfq2.eFrom='Invoice',ioh.fAcceptedAmount,poh.fPOTotal) as fAcceptedAmount, IF(rfq2.eFrom='Invoice',ioh.vBuyerName,poh.vBuyerCompanyName) as vBuyerName, IF(rfq2.eFrom='Invoice',ioh.vSupplierName,poh.vSupplierName) as vSupplierName, sm.vStatus_" . LANG . " as status, r2bd.eStatus, r2bd.eSaved, r2bd.eDelete,
