...
include(S_SECTIONS."/member/memberaccess.php");
   ...
   switch($sess_usertype){
	...
	if($stype == 'act') {
		$where .= " AND ou.eStatus='Active' ";
	} else if($stype == 'inact') {
		$where .= " AND ou.eStatus='Inactive' ";
	}
	if($sfor == 'usr') {
   ...
   // echo $where;
   $jtbl = "INNER JOIN ".PRJ_DB_PREFIX."_organization_master org on (org.iOrganizationID=ou.iOrganizationID AND org.eStatus!='Delete')
