...
$ordt = $orgUserObj->getDetails('*'," AND eStatus='Active' AND eEmailNotification='Yes' AND eUserType='Admin' AND iOrganizationID=".$userData['iOrganizationID']);
...
//				$emailContent=$sendMail->Send($vMailSubject_en,"Member",$emailTo,$body_arr,$post_arr,'','','Yes');
     ...
     $_SESSION['SESS_'.PRJ_CONST_PREFIX.'_MSG']=$var_msg;
           header("Location:".SITE_URL_DUM."oueditprofile/".$var_msg);
}
else {
     $var_msg="raerr.";
     $_SESSION['SESS_'.PRJ_CONST_PREFIX.'_MSG']=$var_msg;
