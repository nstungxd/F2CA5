...
//prints($currency);
$lineItemTax = $gdbobj->getEnumSelect("".PRJ_DB_PREFIX."_purchase_order_heading", "eLineItemTax","Data[eLineItemTax]", "eLineItemTax","setT()", "".$podtls[0]['eLineItemTax'].""," class='' tabindex='11'");
// prints($msg); exit;
$sid = '';
