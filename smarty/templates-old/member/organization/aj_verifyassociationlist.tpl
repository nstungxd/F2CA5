<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   <tr class="{$rowclass}">
      ...
      <td width="100" align="center">{$activegroup[ln].vSupplierCode}</td> {*}vAssociationCode{*}
		<td width="80" height="26" align="left" style="padding-left:2px;">{$activegroup[ln].vBuyerOrg}</td>
		<td width="70" align="center">{$activegroup[ln].vBuyerCode}</td>
		{*assign var="supplier" value=$activegroup[ln].vSupplierOrg|replace:",":"<br/>"}
      <td width="150" align="center"><div style="heigh:30px; overflow-y:scroll;">{$supplier}</div></td>{*}
