<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   {/if}
	<tr class="{$rowclass}">
		...
		<td width="158" height="26" align="left" style="padding-left:2px;">{$orglist[ln].vCompanyName}</td>
	  ...
	  <td width="94" align="center">
			{*}<a href="{$SITE_URL_DUM}createorganizationpref/{$orglist[ln].iOrganizationID}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;{*}
			<a href="{$SITE_URL_DUM}organizationprefview/{$orglist[ln].iOrganizationID}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
