...
<div class="middle-containt">
	<div class="statistics-main-box-white">
		<div>
			<ul id="inner-tab">
				<li><a class="current"><em>{$LBL_BUYER2_BUYER} {$LBL_ASSOCIATION}</em></a></li>
		   </ul>
      </div>
		<div class="clear"></div>
            ...
            <span id="prc" style="display:none; float:right;"> <img src="{$SITE_IMAGES}sm_images/progress.gif" /> Processing ... </span>
               ...
               <tr>
                  ...
                  <td>
                           ...
                           {if $arr[0].iBuyerId>0}
                              <option value="{$arr[0].iBuyerId}" selected="selected">{$arr[0].vBuyer}</option>
                           {/if}
   							</select>
   						</span>
					...
					<tr><td colspan="2">&nbsp;</td></tr>
               <tr>
                  <td valign="top">{$LBL_ACCOUNT}1 {$LBL_TITLE} <font class="reqmsg">*</font> : </td>
                  <td><input type="text" id="vAccount1" name="Data[vAccount1]" value="{$arr[0].vAccount1}" class="required" style="width:270px;" title="{$LBL_ENTER} {$LBL_ACCOUNT}1 {$LBL_TITLE}"/></td>
               </tr>
					<tr>
               ...
               <tr>
                  ...
                  <td><input type="text" id="vAccount2" name="Data[vAccount2]" value="{$arr[0].vAccount2}" class="" style="width:270px;" title="{$LBL_ENTER} {$LBL_ACCOUNT}2 {$LBL_TITLE}"/></td>
               </tr>
					<tr>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jb2buyerasoc.js"></script>
{literal}
...
$('#frmadd').validate({
            ...
            data: {
               ...
               chkfvl: function () {
                  ...
                  return " AND NOT (eStatus='Delete' AND eNeedToVerify='No')";
   				...
   				table:function() {
   					return "{/literal}{$PRJ_DB_PREFIX}{literal}_buyer2_buyer_association";
   				}
   			}
   		}
      }
   ...
   messages: {
      "Data[iBuyerId]": {
         remote: jQuery.validator.format(LBL_BUYER_ALREADY_INASSOCIATION_WITH_SELECTED_BUYER2)
      }
   }
});
