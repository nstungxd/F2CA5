...
<div class="inner-white-bg">
   ...
   <div class="inport-gray-bg">
      ...
      <div class="import-border">&nbsp;{$LBL_SEARCH} : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2buyerasocvlist('all',1)" style="height:19px; text-decoration:none;"><b>{$LBL_GO}</b></a>
      </div>
         ...
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
               ...
               <td width="30%" colspan="3" align="left">
                  ...
                  <a class="btllbl" onclick="getb2buyerasocvlist('srch',1)" style="height:19px; text-decoration:none;"><b>{$LBL_GO}</b></a>
               </td>
            </tr>
         </table>
      </div>
         ...
         <table width="100%" border="0" class="black" cellspacing="0" cellpadding="0">
            ...
            <td class="listing-sky-blue">
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
				        <td width="150" align="left"><a href="javascript:getb2buyerasocvlist('all','1','vBuyer2')">&nbsp;<b>{$LBL_BUYER}2</b></a></td>
				        <td width="150" align="left"><a href="javascript:getb2buyerasocvlist('all','1','vProduct')"><b>{$LBL_BUYER}</b></a></td>
                    <td width="70" align="center"><a href="javascript:getb2buyerasocvlist('all','1','vACode')"><b>{$LBL_CODE}</b></a></td>
                    <td width="70" align="center"><a href="javascript:getb2buyerasocvlist('all','1','eStatus')"><b>{$LBL_STATUS}</b></a></td>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jvlistb2buyerassoc.js"></script>
{literal}
<script>
