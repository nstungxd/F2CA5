...
<div class="middle-containt">
	<div class="statistics-main-box-white">
      ...
      <div class="clear"></div>
		...
		{/if}
		<div>&nbsp;</div>
      <form id="frmadd" name="frmadd" method="post" action="{$SITE_URL}index.php?file=or-b2sprodtasoc_a">
               ...
               <tr>
                  ...
                  <td>
   						<span id="sprdt" style="float:left;">
   							<select name="Data[iProductId]" id="iProductId" style="width:300px;" class="required" title="{$LBL_SELECT} {$LBL_SPRODUCT}">
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jb2sprdtasoc.js"></script>
{literal}
            ...
            data: {
               ...
               chkfvl: function () {
                  ...
                  return " AND NOT (eStatus='Delete' AND eNeedToVerify='No')";
   				...
   				table:function() {
   					return "{/literal}{$PRJ_DB_PREFIX}{literal}_buyer2_sproduct_association";
   				}
   			}
   		}
      }
