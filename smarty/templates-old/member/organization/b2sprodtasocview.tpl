...
<div class="middle-containt">
	<div class="statistics-main-box-white">
		<div>
			<ul id="inner-tab">
				<li><a class="current"><em>{$LBL_BUYER2_SPRODUCT} {$LBL_ASSOCIATION}</em></li>
		   </ul>
      </div>
		<div class="clear"></div>
		<div class="inner-gray-bg" style="height:579px;">
            ...
            {*<span id="prc" style="display:none; float:right;"> <img src="{$SITE_IMAGES}sm_images/progress.gif" /> Processing ... </span>*}
               ...
               <tr>
                  ...
                  <td align="right">
                     ...
                     {/if}
                     <div><span style="float:right;"><b><a class="" href="javascript:openpopup('{$SITE_URL_DUM}index.php?file=or-b2sprdthistory&id={$iAssociationId}')" >{$LBL_VIEW_HISTORY}</a></b></span></div>
                  </td>
               </tr>
               <tr>
               ...
               {/if}
               <tr><td colspan="2" align="right">&nbsp;{*if $vrq eq 'vreq'}<a class="colorbox" onmouseover="CallColoerBox(this.href,700,500,'options');" href="{$SITE_URL_DUM}index.php?file=or-aj_b2sprdtascprv&id={$iAssociationId}">{$LBL_VIEW_PREVIOUS_DETAILS}</a>{/if*}</td></tr>
               <tr>
						<td valign="top">&nbsp;</td>
						<td>
                     {if $vrq eq 'vreq' && $vsts eq 'ucv'}
                     ...
                     {/if}
							{if $vrq eq 'vreq'}
								<span class="btllbl" style=""><a href="{$SITE_URL_DUM}b2sprodtasocvlist"><b id="btnSubmit">{$LBL_CANCEL}</b></a></span>
							{else}
	                     <span class="btllbl" style=""><a href="{$SITE_URL_DUM}b2sprodtasoclist"><b id="btnSubmit">{$LBL_CANCEL}</b></a></span>
							{/if}
						</td>
					</tr>
				</table>
