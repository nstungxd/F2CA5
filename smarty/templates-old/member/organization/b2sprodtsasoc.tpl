<div class="middle-container">
    ...
    <div class="middle-containt">
        <div class="statistics-main-box-white">
            <div>
                <ul id="inner-tab">
                    <li><a class="current"><em>{$LBL_BUYER2_SPRODUCT_SUPPLIER} {$LBL_ASSOCIATION}</em></a></li>
                </ul>
            </div>
            <div class="clear"></div>
                            ...
                            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="5" class="black">
                                ...
                                <tr class="prs" style="display:none;">
                                    ...
                                    <td>
                                        ...
                                        <span class="btllbl" style="height:17px;"><b onclick="getSProductCombo('{$arr[0].iProductId}');">{$LBL_SEARCH}</b></span>
                                        &nbsp; [{$MSG_CAN_USE_WILD_CHAR|stripslashes}]
                                    </td>
                                </tr>
                                <tr>
                                    <td width="190px" valign="top">{$LBL_SELECT} {$LBL_SPRODUCT}&nbsp;<font class="reqmsg">*</font> : </td>
                                    <td>
                                        <span id="bprdt" style="float:left;">
                                            <select name="Data[iProductId]" id="iProductId" style="width:300px;" class="required" title="{$LBL_SELECT} {$LBL_SPRODUCT}" onchange="return bs();">
                                                <option value="">---{$LBL_SELECT} {$LBL_SPRODUCT}---</option>
                                        ...
                                        <span class="prs" style="float:right; padding-right:70px; display:none;">
                                            {$LBL_FILTER_LIST_BY} : <input type="text" name="spfilter" id="spfilter" style="width:100px;" />
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr class="bys" style="display:none;">
                                    ...
                                    <td>
                                        <input type="text" class="ttp" id="bnm" name="bnm" value="{$post_data.bnm}" class="input-rag" style="width:100px; height:17px; vertical-align:middle;" title="{$LBL_NAME}" />&nbsp;
                                        <input type="text" class="ttp" id="bcd" name="bcd" value="{$post_data.bcd}" class="input-rag" style="width:100px; height:17px; vertical-align:middle;" title="{$LBL_CODE}" />&nbsp;
                                    ...
                                    <td>
                                        <span id="borg" style="float:left;">
                                            <select name="Data[iSupplierId]" id="iSupplierId" style="width:300px;" class="required" title="{$LBL_SELECT} {$LBL_SUPPLIER}">
                                                ...
                                                <option value="{$arr[0].iSupplierId}" selected="selected">{$arr[0].vSupplier} ({$arr[0].vSCode})</option>
                                                {/if}
                                            </select>
                                        </span>
    ...
    <script type="text/javascript" src="{$SITE_JS_AJAX}jb2sprdtsasoc.js"></script>
    {literal}
    <script type="text/javascript">
                ...
                "Data[iSupplierId]": {
                    remote: {
                        ...
                        data: {
                            ...
                            table:function() {
                                return "{/literal}{$PRJ_DB_PREFIX}{literal}_buyer2_supplier_sproduct_association";
                            }
                        }
                    }
                }
        ...
        $(document).ready(function() {
            ...
            function opnPrdtls() {
                ...
                var url = '{/literal}{$SITE_URL}{literal}sprodtls/'+$('#iProductId').val()+'/pop';
                openpopup(url);
            }
    ...
    {literal}<script type="text/javascript">getSProductCombo('');</script>{/literal}
    {/if}
