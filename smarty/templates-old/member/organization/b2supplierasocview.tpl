...
<div class="middle-containt">
	<div class="statistics-main-box-white">
		<div>
			<ul id="inner-tab">
				<li><a class="current"><em>{$LBL_BUYER2_SUPPLIER} {$LBL_ASSOCIATION}</em></li>
		   </ul>
      </div>
		<div class="clear"></div>
            ...
            {*<span id="prc" style="display:none; float:right;"> <img src="{$SITE_IMAGES}sm_images/progress.gif" /> Processing ... </span>*}
               ...
               <tr>
                  ...
                  <td align="right">
                     ...
                     {/if}
                     <div><span style="float:right;"><b><a class="" href="javascript:openpopup('{$SITE_URL_DUM}index.php?file=or-b2supplierhistory&id={$iAssociationId}')" >{$LBL_VIEW_HISTORY}</a></b></span></div>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td>{$arr[0].vSupplier} ({$arr[0].vCompCode})</td>
				  	</tr>
               <tr>
               ...
               <tr>
                     ...
                     {/if}
                     {if $vrq eq 'vreq'}
								<span class="btllbl" style=""><a href="{$SITE_URL_DUM}b2supplierasocvlist"><b id="btnSubmit">{$LBL_CANCEL}</b></a></span>
							{else}
	                     <span class="btllbl" style=""><a href="{$SITE_URL_DUM}b2supplierasoclist"><b id="btnSubmit">{$LBL_CANCEL}</b></a></span>
							{/if}
						</td>
					</tr>
				</table>
