...
<div class="middle-containt">
   <div class="statistics-main-box-white">
      <div>
         <ul id="inner-tab">
			   <li><a href="#" class="current"><EM>P{$LBL_PROFILE_INFO}</EM></a></li>
         </ul>
      </div>
      <div class="clear"></div>
      <div class="inner-gray-bg">
         ...
         <div>
              {if $msg neq ''}
                    ...
                    {/literal*}
                    {/if}
            <form name="frmadd" id="frmadd" action="{$SITE_URL}index.php?file=or-oaeditprofile_a" method="post">
               ...
               <tr>
                  <td>&nbsp;</td>
                  <td colspan="2" >
                       <img tabindex="25" id="btnSubmit" name="Submit" title="submit" src="{$SITE_IMAGES}sm_images/btn-submit.gif" alt="" onclick="submitform()" style="background: #f8f8f8;cursor:pointer; vertical-align:middle;border:none;"/> &nbsp;
