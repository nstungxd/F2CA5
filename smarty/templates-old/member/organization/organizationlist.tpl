...
<h1><span class="">{$LBL_ORG_LIST}</span></h1> <!-- blue-hadd-bg -->
...
<div class="inner-white-bg">
   ...
   <div class="inport-gray-bg">
      ...
      <div class="import-border">&nbsp;{$LBL_SEARCH} : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         &nbsp; <input type="image" src="{$SITE_IMAGES}sm_images/btn-go.gif"  alt=""  style="cursor: pointer; vertical-align:middle;border:none;background: #f8f8f8;" onclick="getorglist('all',1)" />
      </div>
         ...
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
               ...
               <td>
                  ...
                  &nbsp; <input type="image" src="{$SITE_IMAGES}sm_images/btn-go.gif" alt=""   style="cursor: pointer; vertical-align:middle;border:none;background: #f8f8f8;" onclick="getorglist('srch',1)" />
               </td>
            </tr>
         </table>
      </div>
            ...
            <td class="listing-sky-blue">
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    ...
                    <td width="62" align="center"><a href="javascript:getorglist('all','1','org.eStatus')"><strong>Status</strong></a></td>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jlistorgs.js"></script>
{literal}
<script>
$(document).ready(function() {
	var msg='{/literal}{$msg}{literal}';
