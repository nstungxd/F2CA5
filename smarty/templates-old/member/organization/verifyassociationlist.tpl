...
<h1><span class="">{$LBL_ASS_VRF_LIST}</span></h1> <!-- blue-hadd-bg -->
      ...
      <div  style="padding:5px;">
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
               ...
               </span>&nbsp; <input type="image" src="{$SITE_IMAGES}sm_images/btn-go.gif" alt=""   style="cursor: pointer; vertical-align:middle;background: #f8f8f8;border:none;" onclick="getassoclist('srch',1)" /></td>
            </tr>
         </table>
      </div>
   </div>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jverifylistassociation.js"></script>
{if $msg neq ''}
{literal}
