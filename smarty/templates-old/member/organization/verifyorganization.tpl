...
<div class="inner-white-bg">
   ...
   <div class="inport-gray-bg">
      ...
      <div class="import-border">&nbsp;{$LBL_SEARCH} : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         &nbsp; <input type="image" src="{$SITE_IMAGES}sm_images/btn-go.gif"  alt="" border="0" style="cursor: pointer; vertical-align:middle;border:none;background: #f8f8f8;" onclick="getorglist('all',1)" />
      </div>
         ...
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
               ...
               <td>
                  ...
                  &nbsp; <input type="image" src="{$SITE_IMAGES}sm_images/btn-go.gif" alt="" border="0"  style="cursor: pointer; vertical-align:middle;border:none;background: #f8f8f8;" onclick="getorglist('srch',1)" />
               </td>
            </tr>
         </table>
      </div>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jverifyorglist.js"></script>
