<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   <tr class="{$rowclass}">
		...
		<td width="188" align="left" style="padding-left:2px;">{$activegroup[ln].vCompanyName}</td>
	  ...
	  <td width="94" align="center">
			<a href="{$SITE_URL_DUM}creategroup/{$activegroup[ln].iGroupID}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			...
			<img src="{$SITE_IMAGES}sm_images/icon-delete.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" onClick="Delete('delete','{$activegroup[ln].iGroupID}')"/>
	  </td>
	</tr>
	{/section}
</table>
