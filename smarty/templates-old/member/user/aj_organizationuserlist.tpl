<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   <tr class="{$rowclass}">
	  ...
	  <td width="94" align="center">
			{if $sess_usertype_short eq 'OA' && $iUserId eq $userlist[ln].iUserID}
				&nbsp;<a href="{$SITE_URL_DUM}organizationuserview/{$userlist[ln].iUserID}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a>&nbsp;
			{else}
			<a href="{$SITE_URL_DUM}createorganizationuser/{$userlist[ln].iUserID}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="vertical-align:middle;" /></a> &nbsp;
			<a href="{$SITE_URL_DUM}organizationuserview/{$userlist[ln].iUserID}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a> &nbsp;
			<img src="{$SITE_IMAGES}sm_images/icon-delete.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" onClick="Delete('delete','{$userlist[ln].iUserID}')" />
			{/if}
	  </td>
	</tr>
	{/section}
