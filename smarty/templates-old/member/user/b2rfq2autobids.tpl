<div class="middle-container">
    <h1>{$LBL_VIEW} {$LBL_RFQ2} {$LBL_AUTO_BIDS}</h1>
    <div class="middle-containt">
        <div class="statistics-main-box-white">
            <div>
                <ul id="inner-tab">
                  <li><a href="{$SITE_URL_DUM}b2rfq2view/{$iRFQ2Id}" ><em>{$LBL_VIEW} {$LBL_RFQ2}</em></a></li>
						{*<li><a class="current pointer"><em>{$LBL_AUTO_BID} {$LBL_SETTINGS}</em></a></li>*}
						<li><a href="{$SITE_URL_DUM}rfq2bidhistory/{$iRFQ2Id}" class=""><em>{$LBL_RFQ2} {$LBL_BIDS}</em></a></li>
                </ul>
            </div>
            <div class="clear"></div>
            <div class="inner-gray-bg">
               ...
               <div id="r2bh">
                <div>
						  <div><span class="blue-ore">{$LBL_FILTER} {$LBL_AUTO_BIDS}: &nbsp; </span> &nbsp; <input type="text" name="filterrfq2bid" id="filterrfq2bid" style="width:390px";></div>
						  <div>&nbsp;</div>
