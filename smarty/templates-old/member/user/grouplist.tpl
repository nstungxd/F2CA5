...
<h1><span class="">{$LBL_GROUP_LIST}</span></h1> <!-- blue-hadd-bg -->
...
<div class="inner-white-bg">
   ...
   <div class="inport-gray-bg">
      ...
      <div class="import-border">&nbsp;{$LBL_SEARCH} : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         &nbsp; <input type="image" src="{$SITE_IMAGES}sm_images/btn-go.gif"  alt="" style="cursor: pointer; vertical-align:middle;background: #f8f8f8;border: none" onclick="getgrouplist('all',1)" />
      </div>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jlistgroup.js"></script>
{if $msg neq ''}
{literal}
