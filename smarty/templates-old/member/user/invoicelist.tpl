     ...
     <tr>
       <td height="35">
            {if $usertype neq 'orgadmin'}
                 {if $invCreate eq 'Yes'}<a href="{$SITE_URL_DUM}invoicecreate"><img src="{$SITE_IMAGES}sm_images/btn-create.gif" alt="" border="0" style="vertical-align:middle;" /></a>{/if}
      ...
      <tr>
        <td width="148" height="26"> &nbsp;
             {if $usertype neq 'orgadmin'}
               ...
               <strong>Invoice Number</strong></a></td>
