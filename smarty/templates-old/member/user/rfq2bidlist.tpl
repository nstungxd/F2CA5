    ...
    <td class="listing-sky-blue">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td width="95" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong>{$LBL_INV_CODE}</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong>{$LBL_AMOUNT}</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','vProductName')"><strong>{$LBL_PRODUCT}</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vBuyerName')"><strong>{$LBL_BUYER}</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vSupplierName')"><strong>{$LBL_SUPPLIER}</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','org.vCompanyName')"><strong>{$LBL_BUYER2}</strong></a></td>
