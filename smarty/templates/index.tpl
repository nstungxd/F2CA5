...
{if $file neq '' && !$file|@in_array:$notUserTop }
    ...
    <!-- this page poacptlist styles -->
    <link rel="stylesheet" href="{$SITE_CSS}libs/daterangepicker.css" type="text/css" />
    <link rel="stylesheet" href="{$SITE_CSS}libs/jquery-jvectormap-1.2.2.css" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{$SITE_CSS}libs/dataTables.tableTools.css">
    <link rel="stylesheet" type="text/css" href="{$SITE_CSS}libs/tablesaw.css">

    <!-- this page edit profile styles -->
    <link rel="stylesheet" href="{$SITE_CSS}libs/select2.css" type="text/css" />
   {* <link rel="stylesheet" type="text/css" href="{$SITE_CSS}libs/nifty-component.css"/>*}

     <!-- this page invoice list styles -->
    <link rel="stylesheet" href="{$SITE_CSS}libs/bootstrap-timepicker.css" type="text/css" />
    <link href="{$SITE_URL_DUM}components/colorbox/css/colorbox.css" rel="stylesheet" type="text/css"/>
...
<body id="{$bodyid}" class="theme-whbl  fixed-header pace-done fixed-leftmenu" onload="njs();">
{*<a href="{$SITE_URL_DUM}changepass/{$iUserId}"
