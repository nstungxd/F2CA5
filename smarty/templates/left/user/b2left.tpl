						...
						<div id="col-left-inner" class="col-left-nano-content">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="sidebar-nav">
								<ul class="nav nav-pills nav-stacked">
									...
									<li {if '/(.*)(oudashboard)(.*)/'|preg_match:$currentUrl || '/(.*)(inbox)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
                                        ...
                                        <ul class="submenu">
											<li>
												<a href="{$SITE_URL_DUM}oudashboard" {if '/(.*)(oudashboard)(.*)/'|preg_match:$currentUrl}class="active"{/if}>
													{$LBL_DASHBOARD}
												</a>
											</li>
											<li>
									...
									<li {if '/(.*)(polist)(.*)/'|preg_match:$currentUrl || '/(.*)(purchaseorderview)(.*)/'|preg_match:$currentUrl || '/(.*)(poprefview)(.*)/'|preg_match:$currentUrl || '/(.*)(poviewitems)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
                                    ...
                                    <li {if '/(.*)(invoicelist)(.*)/'|preg_match:$currentUrl || $currentUrl|strripos:$invu gt 0 || '/(.*)(invoiceview)(.*)/'|preg_match:$currentUrl || '/(.*)(invprefview)(.*)/'|preg_match:$currentUrl || '/(.*)(invoiceviewitems)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
											<i class="fa fa-inbox"></i>
									...
									<li {if '/(.*)(poacptlist)(.*)/'|preg_match:$currentUrl || '/(.*)(purchaseorderview)(.*)/'|preg_match:$currentUrl || '/(.*)(poprefview)(.*)/'|preg_match:$currentUrl || '/(.*)(poviewitems)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
                                    ...
                                    <li {if '/(.*)(invacptlist)(.*)/'|preg_match:$currentUrl || $currentUrl|strripos:$invu gt 0 || '/(.*)(invoiceview)(.*)/'|preg_match:$currentUrl || '/(.*)(invprefview)(.*)/'|preg_match:$currentUrl || '/(.*)(invoiceviewitems)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
											<i class="fa fa-file-o"></i>
											<span>{$LBL_PO_ACCEPTANCE}</span>
											<i class="fa fa-angle-right drop-icon"></i>
                                    ...
                                    {assign var="invu" value='invacptlist'}
                                    <li {if '/(.*)(rfq2)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
											<i class="fa fa-file-o"></i>
											<span>{$LBL_RFQ2}</span>
											<i class="fa fa-angle-right drop-icon"></i>
                                    ...
                                    <li {if '/(.*)(reportsrpt)(.*)/'|preg_match:$currentUrl} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
											<i class="fa fa-file-o"></i>
                                    ...
                                    <li {if '/(.*)(oueditprofile)(.*)/'|preg_match:$currentUrl || '/(.*)(changepass)(.*)/'|preg_match:$currentUrl || $currentUrl eq $SITE_URL_DUM|cat:'logout'} {else}style="display:none;"{/if}>
										<a href="#" class="dropdown-toggle">
											<i class="fa fa-file-o"></i>
