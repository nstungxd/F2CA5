	...
	<tr class="{$rowclass}">
      ...
      {*}<td width="150" align="center" style="height:50px;"><div style="height:50px; overflow-y:scroll;"><p style="height:1px;">&nbsp;</p>{$supplier}</br/><p style="height:1px;">&nbsp;</p></div></td>{*}
	   ...
	   <td width="94" align="center">
			<a href="{$SITE_URL_DUM}b2bprodtasoc/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
