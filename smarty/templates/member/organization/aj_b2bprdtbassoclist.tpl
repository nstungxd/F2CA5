<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   {/if}
	<tr class="{$rowclass}">
      ...
      <td width="100" align="left" style="padding-left:2px;">{$asocs[ln].vProduct}</td>
      <td width="100" align="left" style="padding-left:2px;">{$asocs[ln].vBuyer}</td>
		<td width="70" align="center">{$asocs[ln].vACode}</td>
      {*assign var="supplier" value=$asocs[ln].vSupplierOrg|replace:",":"<br/>"*}
      {*}<td width="150" align="center" style="height:50px;"><div style="height:50px; overflow-y:scroll;"><p style="height:1px;">&nbsp;</p>{$supplier}</br/><p style="height:1px;">&nbsp;</p></div></td>{*}
	   ...
	   <td width="70" align="center">
			{if $uorg_type eq 'Buyer2' || $sess_usertype_short eq 'SM'}
			<a href="{$SITE_URL_DUM}b2bprodtbasoc/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			{/if}
		   <a href="{$SITE_URL_DUM}b2bprodtbasocview/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
