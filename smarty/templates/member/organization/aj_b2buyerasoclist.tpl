<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   {/if}
	<tr class="{$rowclass}">
      ...
      <td width="80" align="left" style="padding-left:2px;">{$asocs[ln].vBuyer}</td>
	   ...
	   <td width="94" align="center">
			{if $uorg_type eq 'Buyer2' || $sess_usertype_short eq 'SM'}
				<a href="{$SITE_URL_DUM}b2buyerasoc/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			{/if}
		   <a href="{$SITE_URL_DUM}b2buyerasocview/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
