<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   {/if}
	<tr class="{$rowclass}">
      ...
      <td width="100" align="left" style="padding-left:2px;">{$asocs[ln].vSupplier}</td>
	   ...
	   <td width="70" align="center">
			...
			<a href="{$SITE_URL_DUM}b2sprodtsasoc/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			{/if}
		   <a href="{$SITE_URL_DUM}b2sprodtsasocview/{$asocs[ln].iAssociationId}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
