<table width="100%" border="0" cellspacing="1" cellpadding="1">
   ...
   {/if}
	<tr class="{$rowclass}">
		<td width="100" align="left" style="padding-left:3px;">{$asocs[ln].vBuyer2}</td>
      <td width="100" align="left" style="padding-left:3px;">{$asocs[ln].vProduct}</td>
		<td width="100" align="left" style="padding-left:3px;">{$asocs[ln].vSupplier}</td>
