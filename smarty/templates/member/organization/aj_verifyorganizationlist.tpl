   ...
   {/if}
	<tr class="{$rowclass}">
		<!--<td width="30" height="26" class="golden" align="center">
			<input type="checkbox" class="radib-btn" name="organizations[]" id="iOrganizationID" value="{$orglist[ln].iVerifiedID}" />
		</td>-->
		<td width="158" height="26" align="left" style="padding-left:3px;">{$orglist[ln].vCompanyName}</td>
