...
<div class="inner-white-bg">
   ...
   <div class="inport-gray-bg">
      ...
      <div class="import-border">&nbsp;{$LBL_SEARCH} : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2bprdtassoclist('all',1)" style="height:19px; text-decoration:none;"><b>{$LBL_GO}</b></a>
      </div>
         ...
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
               ...
               <td width="30%" colspan="3" align="left">
                  ...
                  <a class="btllbl" onclick="getb2bprdtassoclist('srch',1)" style="height:19px; text-decoration:none;"><b>{$LBL_GO}</b></a>
               </td>
            </tr>
         </table>
      </div>
   ...
   <div>
      <div style="height:25px; padding-right:10px;" align="right">
			{if ($uorg_type eq 'Buyer2' && $sess_usertype_short eq 'OA') || $sess_usertype_short eq 'SM'} {*|| $smarty.session.SESS_B2B_USRTYPE eq 'Buyer'*}
				<span class="btllbl" style="float:left;"><a href="{$SITE_URL_DUM}b2bprodtasoc" style="textarea-decoration:none;"><b>{$LBL_CREATE}</b></a></span>
			{/if}
               ...
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td width="20" height="26" align="center"><input type="checkbox" class="radib-btn" name="checkbox" id="checkbox" /></td>
				        <td width="100" align="left"><a href="javascript:getb2bprdtassoclist('all','1','vBuyer2')"><b>{$LBL_BUYER}2</b></a></td>
				        <td width="80" align="left"><a href="javascript:getb2bprdtassoclist('all','1','vProduct')"><strong>{$LBL_BPRODUCT}</strong></a></td>
                    <td width="70" align="center"><a href="javascript:getb2bprdtassoclist('all','1','vACode')"><strong>{$LBL_CODE}</strong></a></td>
                    <td width="62" align="center"><a href="javascript:getb2bprdtassoclist('all','1','eStatus')"><strong>{$LBL_STATUS}</strong></a></td>
                    <td width="94" align="center">{$LBL_ACTION}</td>
                  </tr>
               </table>
            </td>
         </tr>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jlistb2bprdtassoc.js"></script>
{literal}
<script>
