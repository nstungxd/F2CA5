                        ...
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="5" class="black">
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    {/if}
                                    <div><span style="float:right;"><b><a class="" href="javascript:openpopup('{$SITE_URL_DUM}index.php?file=or-b2bprdtbhistory&id={$iAssociationId}')" >{$LBL_VIEW_HISTORY}</a></b></span></div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{$arr[0].vBuyer} ({$arr[0].vB2Code})</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {/if}
                                    {if $vrq eq 'vreq'}
                                    <span class="btllbl" style=""><a href="{$SITE_URL_DUM}b2bprdtbasocvlist"><b id="btnSubmit">{$LBL_CANCEL}</b></a></span>
                                    {else}
                                    <span class="btllbl" style=""><a href="{$SITE_URL_DUM}b2bprodtbasoclist"><b id="btnSubmit">{$LBL_CANCEL}</b></a></span>
                                    {/if}
                                </td>
                            </tr>
                        </table>
