...
<div class="inner-white-bg">
   ...
   <div class="inport-gray-bg">
      ...
      <div class="import-border">&nbsp;{$LBL_SEARCH} : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2supplierassoclist('all',1)" style="height:19px; text-decoration:none;"><b>{$LBL_GO}</b></a>
      </div>
         ...
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr>
               ...
               <td width="30%" colspan="3" align="left">
                  ...
                  <a class="btllbl" onclick="getb2supplierassoclist('srch',1)" style="height:19px; text-decoration:none;"><b>{$LBL_GO}</b></a>
               </td>
            </tr>
         </table>
      </div>
   ...
   <div>
      <div style="height:25px; padding-right:10px;" align="right">
         {if ($uorg_type eq 'Buyer2' && $sess_usertype_short eq 'OA') || $sess_usertype_short eq 'SM'}
			<span class="btllbl" style="float:left;"><a href="{$SITE_URL_DUM}b2supplierasoc" style="textarea-decoration:none;"><b>{$LBL_CREATE}</b></a></span>
			{/if}
               ...
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td width="20" height="26" align="center"><input type="checkbox" class="radib-btn" name="checkbox" id="checkbox" /></td>
				        <td width="100" align="left"><a href="javascript:getb2supplierassoclist('all','1','vBuyer2')"><b>{$LBL_BUYER}2</b></a></td>
				        <td width="80" align="left"><a href="javascript:getb2supplierassoclist('all','1','vSupplier')"><strong>{$LBL_SUPPLIER}</strong></a></td>
                    <td width="70" align="center"><a href="javascript:getb2supplierassoclist('all','1','vACode')"><strong>{$LBL_CODE}</strong></a></td>
                    <td width="62" align="center"><a href="javascript:getb2supplierassoclist('all','1','eStatus')"><strong>{$LBL_STATUS}</strong></a></td>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jlistb2supplierassoc.js"></script>
{if $msg neq ''}
{literal}
