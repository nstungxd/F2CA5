<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr class="{$rowclass}">
      ...
      <td width="50" align="center">
			<a href="{$SITE_URL_DUM}b2rfq2awardview/{$dtls[i].iAwardId}">{if $dtls[i].eStatus|trim|strtolower eq 'rejected'}<img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" title="{$LBL_AWARD}" border="0" style="vertical-align:middle;" />{else}<img src="{$SITE_IMAGES}check.gif"  alt="" title="{$LBL_AWARD}" border="0" style="vertical-align:middle;" />{/if}</a>&nbsp;
      </td>
   </tr>
   {/section}
</table>
