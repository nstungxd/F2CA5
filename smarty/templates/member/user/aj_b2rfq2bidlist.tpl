<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr class="{$rowclass}">
      ...
      <td width="50" align="center">
			...
			<a href="{$SITE_URL_DUM}b2rfq2view/{$dtls[i].iRFQ2Id}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a>&nbsp;
			{else}
			<a href="{$SITE_URL_DUM}viewsrfq2bid/{$dtls[i].iBidId}"><img src="{$SITE_IMAGES}sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a>&nbsp;
			{/if}
        </td>
   </tr>
   {/section}
