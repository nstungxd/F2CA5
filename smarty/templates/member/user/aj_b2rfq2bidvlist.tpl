<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr class="{$rowclass}">
      ...
      <td width="50" align="center">
			{*if $dtls[i].eSaved eq 'Yes' && $dtls[i].rfq2Status eq 'Live'}
			...
			{else}{/if*}
			<a href="{$SITE_URL_DUM}viewsrfq2bid/{$dtls[i].iBidId}"><img src="{$SITE_IMAGES}check.gif{*$SITE_IMAGES}sm_images/icon-edit.gif{*}"  alt="" title="{$LBL_VIEW}" border="0" style="vertical-align:middle;" /></a>&nbsp;
			{*<a style="cursor:pointer;" onclick="return vrfybd('{$dtls[i].iBidId}');"><img src="{$SITE_IMAGES}check.gif"  alt="" title="{$LBL_VERIFY}" border="0" style="vertical-align:middle;" /></a>&nbsp;*}
        </td>
   </tr>
   {/section}
</table>
