<table id="table-example" class="table table-hover tablesaw" data-tablesaw-mode="columntoggle"
    ...
    <tr>
        <th scope="col" data-tablesaw-priority="persist" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','rfq2.vRFQ2Code')"$LBL_RFQ2_CODE}</a></th>
        <th scope="col" data-tablesaw-priority="1" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','ioh.vInvoiceCode')">{$LBL_INV_CODE}</a></th>
        <th scope="col" data-tablesaw-priority="2" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','ioh.vInvoiceCode')">{$LBL_AMOUNT}</a></th>
        <th scope="col" data-tablesaw-priority="3" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','vProductName')">{$LBL_PRODUCT}</a></th>
        <th scope="col" data-tablesaw-priority="4" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','ioh.vBuyerName')">{$LBL_BUYER}</a></th>
        <th scope="col" data-tablesaw-priority="5" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','ioh.vSupplierName')">{$LBL_SUPPLIER}</a></th>
        <th scope="col" data-tablesaw-priority="6" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','org.vCompanyName')">{$LBL_BUYER2}</a></th>
        <th scope="col" data-tablesaw-priority="7" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','rfq2.eAuctionType')">{$LBL_TYPE}</a></th>
        <th scope="col" data-tablesaw-priority="8" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','rfq2.eBidCriteria')">{$LBL_CRITERIA}</a></th>
        <th scope="col" data-tablesaw-priority="9" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','r2bd.dBidDate')">{$LBL_BID} {$LBL_DATE}</a></th>
        <th scope="col" data-tablesaw-priority="10" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','r2bd.fBidAdvanceTotal,r2bd.fBidPriceTotal')">{$LBL_BID} {$LBL_AMOUNT}</a>
        </th>
        <th scope="col" data-tablesaw-priority="11" class="text-center"><a
                href="javascript:getrfq2awardlist('all','1','r2aw.eStatus')">{$LBL_STATUS}</a></th>
   ...
   <tr>
      ...
      <td class="text-center">
			<a href="{$SITE_URL_DUM}rfq2awardview/{$dtls[i].iAwardId}">{if $dtls[i].eStatus|trim|strtolower eq 'rejected'}
                <span class="fa-stack">
