<div class="middle-container">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="30px">
                                ...
                                <a class="btllbl" style="textarea-decoration:none;" href="{$SITE_URL_DUM}b2rfq2view/0"><b>{$LBL_BID_NOW}</b></a>
                                {/if}
                            </td>
                            <td align="right">
                    ...
                    <table width="100%" border="0" class="black" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" name="chkbidstatus" id="chkbidstatus" value="{$chkbidstatus}" />
    ...
    <script type="text/javascript" src="{$SITE_JS_AJAX}jlistb2rfq2bid.js"></script>
    {literal}
