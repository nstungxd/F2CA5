<div class="middle-container">
    <h1><span class="">{$LBL_RFQ2} {$LBL_BID} {$LBL_LIST}</span></h1> <!-- blue-hadd-bg -->
    <div class="middle-containt">
        <div class="inner-white-bg">
            <div><h2 style="height:25px;"><a href="javascript:history.back(-1);"><img src="{$SITE_IMAGES}sm_images/hadding-arrow.gif" alt="" border="0"  style="vertical-align:middle;"/></a>&nbsp; Search <span><img src="{$SITE_IMAGES}sm_images/btn-show-all.gif"  alt="" border="0" style="vertical-align:middle;" onclick="getrfq2bidlist('all',1)" /></span></h2></div>
            <div class="inport-gray-bg">
                <table width="100%" border="0" cellspacing="5" class="black" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            {$bidcriteria} &nbsp;&nbsp;&nbsp;
                            <a class="btllbl" style="textarea-decoration:none;" onclick="getrfq2bidlist('srch',1)"><b>{$LBL_SEARCH}</b></a>
                        </td>
                    </tr>
                    {*<tr>
                        <td>{$LBL_BID_CRITERIA} : </td>
            ...
            <div>
                <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="30px">{*<a class="btllbl" style="width:59px; textarea-decoration:none;" href="{$SITE_URL_DUM}b2rfq2view/0"><b>{$LBL_BID_NOW}</b></a>*}</td>
                            <td align="right">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="100" height="27" align="left">&nbsp;
                                            ...
                                            {/if*}
                                            <a href="javascript:getrfq2bidlist('all','1','rfq2.vRFQ2Code')"><strong>{$LBL_RFQ2_CODE}</strong></a>
                                        </td>
                                        <td width="100" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong>{$LBL_INV_CODE}</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong>{$LBL_AMOUNT}</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2bidlist('all','1','vProductName')"><strong>{$LBL_PRODUCT}</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vBuyerName')"><strong>{$LBL_BUYER}</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vSupplierName')"><strong>{$LBL_SUPPLIER}</strong></a></td>
                                        <td width="40" align="center"><a href="javascript:getrfq2bidlist('all','1','rfq2.eAuctionType')"><strong>{$LBL_TYPE}</strong></a></td>
                                        <td width="30" align="center"><a href="javascript:getrfq2bidlist('all','1','rfq2.eBidCriteria')"><strong>{$LBL_CRITERIA}</strong></a></td>
                                        <td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','r2bd.dBidDate')"><strong>{$LBL_BID} {$LBL_DATE}</strong></a></td>
                                        {*<td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','rdays,rtime')"><strong>{$LBL_TIME_LEFT}</strong></a></td>*}
                                        <td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','r2bd.fBidAdvanceTotal,r2bd.fBidPriceTotal')"><strong>{$LBL_BID} {$LBL_AMOUNT}</strong></a></td>
                                        {*<td width="63" align="center"><a href="javascript:getrfq2bidlist('all','1','rfq2.fTotalBids')"><strong>{$LBL_TOTAL_BIDS}</strong></a></td>*}
                                        <td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','r2bd.eStatus')"><strong>{$LBL_STATUS}</strong></a></td>
                        ...
                        <tr>
                            <td>
                                ...
                                <form name="exp" id="exp" method="post" action="">
                                    ...
                                    <input type="hidden" name="iBidId" id="bidId" value="" />
                                    <div id="grouplist">
    ...
    <script type="text/javascript" src="{$SITE_JS_AJAX}jvlistb2rfq2bid.js"></script>
    {literal}
    <script type="text/javascript">
        function vrfybd(vl)
        {
            $('#bidId').val(vl);
            $('#view').val('verify');
            $('#exp').attr("action", SITE_URL+"index.php?file=u-rfq2bidcreate_a");
            $('#exp')[0].submit();
        }
