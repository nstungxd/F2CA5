<div class="middle-container">  
            ...
            <div class="inport-gray-bg">
                <table width="100%" border="0" cellspacing="5" class="black" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>{*$LBL_END_DATE*}{$LBL_START_DATE} ({$LBL_TO|ucfirst}) :</td>
                        <td>
                        ...
                        <tr>
                            <td height="30px">
                                <div align="left" width="50%">
                                    ...
                                    <a class="btllbl" style="textarea-decoration:none;" onclick="addwatchlist()"><b>{$LBL_ADDTOWATCHLIST}</b></a>
                                    {/if}
                                </div>
                            </td>
                            <td align="right">
                    ...
                    <table width="100%" border="0" class="black" cellspacing="0" cellpadding="0">
                            ...
                            <td class="listing-sky-blue">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="70" align="left"><a href="javascript:getrfq2list('all','1','ioh.vInvoiceCode')"><strong>{$LBL_AMOUNT}</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2list('all','1','vProductName')"><strong>{$LBL_PRODUCT}</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2list('all','1','ioh.vBuyerName')"><strong>{$LBL_BUYER}</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2list('all','1','ioh.vSupplierName')"><strong>{$LBL_SUPPLIER}</strong></a></td>
                                        <td width="40" align="center"><a href="javascript:getrfq2list('all','1','rfq2.eAuctionType')"><strong>{$LBL_TYPE}</strong></a></td>
                                        <td width="30" align="center"><a href="javascript:getrfq2list('all','1','rfq2.eBidCriteria')"><strong>{$LBL_CRITERIA}</strong></a></td>
                                        <td width="70" align="center"><a href="javascript:getrfq2list('all','1','rfq2.dStartDate')"><strong>{$LBL_TIME_LEFT}</strong></a></td>
                                        {*<td width="70" align="center"><a href="javascript:getrfq2list('all','1','rdays,rtime')"><strong>{$LBL_TIME_LEFT}</strong></a></td>*}
                                        <td width="70" align="center"><a href="javascript:getrfq2list('all','1','rfq2.fBestBidAmount')"><strong>{$LBL_BEST_BID}</strong></a></td>
                                        <td width="63" align="center"><a href="javascript:getrfq2list('all','1','rfq2.fTotalBids')"><strong>{$LBL_TOTAL_BIDS}</strong></a></td>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" name="auction" id="auction" value="{$auctionstatus}" />
    ...
    <script type="text/javascript" src="{$SITE_JS_AJAX}jlistb2rfq2.js"></script>
    {literal}
