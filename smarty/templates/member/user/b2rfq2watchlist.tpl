<div class="middle-container">   
            ...
            <div>
                <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td height="30px">
                                <a class="btllbl" style="textarea-decoration:none;" onclick="removewatchlist()"><b>{$LBL_REMOVE}</b></a>
                    ...
                    <table width="100%" border="0" class="black" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td class="listing-sky-blue">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="125" height="27" align="left">&nbsp;
    ...
    <script type="text/javascript" src="{$SITE_JS_AJAX}jlistb2rfq2watch.js"></script>
    {literal}
    <script type="text/javascript">
        ...
        function removewatchlist()
        {
            if($('input:checked[name="iRFQ2Id\[\]"]').length>0) {
                ...
                var url1= SITE_URL+'index.php?file=u-aj_removewatchlist';
