...
<div class="inner-white-bg">
   ...
   <div>
        <div style="height:25px;" align="right">
             ...
             <img src="{$SITE_IMAGES}sm_images/btn-delete-all.gif" alt="" border="0" style="cursor:pointer;border: none; padding-right: 5px;vertical-align:top;" onClick="Delete('deleteall','')" /></div>
...
<script type="text/javascript" src="{$SITE_JS_AJAX}jlistusers.js" async="async"></script>
{literal}
