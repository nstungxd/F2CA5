...
<div class="middle-container">
    ...
    <div class="middle-containt">
        <div class="statistics-main-box-white">
            <div>
                <ul id="inner-tab">
                    <li><a href="{$SITE_URL_DUM}purchaseordercreate/{$iPurchaseOrderID}"><em>{$LBL_PO_HEADER}</em></a></li>
            ...
            <div class="inner-gray-bg">
                ...
                <div>
                    ...
                    {/literal*}
                    {/if}
                    <form name="frmadd" id="frmadd" action="{$SITE_URL}index.php?file=u-popref_a"  method="post" enctype="multipart/form-data">
                        ...
                        <table width="97%" border="0" align="center" cellpadding="0" cellspacing="5" class="black">
                            ...
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore" valign="top"><textarea name="Data[tSourcingDocument]" id="tSourcingDocument" cols="100" rows="5">{$poprefdt[0].tSourcingDocument|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_GLOBAL_AGREEMENT} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tGlobalAgreement]" id="tGlobalAgreement" cols="100" rows="5">{$poprefdt[0].tGlobalAgreement|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_PAYMENT_TERMS} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tPaymentTerms]" id="tPaymentTerms" cols="100" rows="5">{$poprefdt[0].tPaymentTerms|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_FOB} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tFOB]" id="tFOB" cols="100" rows="5">{$poprefdt[0].tFOB|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_DELIVERY_TERMS} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tDeliveryTerms]" id="tDeliveryTerms" cols="100" rows="5">{$poprefdt[0].tDeliveryTerms|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_SHIP_CONTROL} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tShippingControl]" id="tShippingControl" cols="100" rows="5">{$poprefdt[0].tShippingControl|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_COND_PAYMENT} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tConditionsForPayment]" id="tConditionsForPayment" cols="100" rows="5">{$poprefdt[0].tConditionsForPayment|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_PENALTIES} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tPenalties]" id="tPenalties" cols="100" rows="5">{$poprefdt[0].tPenalties|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_SPEC_INSTRUCT} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tSpecialInstruction]" id="tSpecialInstruction" cols="100" rows="5">{$poprefdt[0].tSpecialInstruction|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                                <td valign="top">{$LBL_NOTE} </td>
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tNote]" id="tNote" cols="100" rows="5">{$poprefdt[0].tNote|stripslashes}</textarea></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td colspan="2">
                                    <a href="{$SITE_URL_DUM}purchaseordercreate/{$iPurchaseOrderID}"><img src="{$SITE_IMAGES}sm_images/btn-back.gif"  alt="" border="0" id="btnBack" name="Back" style="vertical-align:middle;cursor: pointer;" /></a>&nbsp;
