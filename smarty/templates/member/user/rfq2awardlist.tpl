<div id="content-wrapper">
        ...
        <div class="col-lg-12">
            <div id="content-header" class="clearfix">
                <div class="pull-left">
                    ...
                    <h1>{$LBL_RFQ2} {$LBL_AWARD} {$LBL_LIST}</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="alert" role="alert">
        ...
        <button type="button"  class="btn btn-primary" onclick="getrfq2awardlist('all',1)">Show all</button>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
                ...
                <div class="form-group">
                    <label></label>
                    <div class="input-group">
                        <button class="btn btn-success" type="button" onclick="getrfq2awardlist('srch',1)">{$LBL_SEARCH}</button>
                    </div>
                </div>
        </div>
    </div>
