<div class="middle-container">
    ...
    <div class="middle-containt">
        <div class="inner-white-bg">
            <div><h2 style="height:25px;"><a href="javascript:history.back(-1);"><img src="{$SITE_IMAGES}sm_images/hadding-arrow.gif" alt="" border="0"  style="vertical-align:middle;"/></a>&nbsp; Search <span><img src="{$SITE_IMAGES}sm_images/btn-show-all.gif"  alt="" border="0" style="vertical-align:middle;" onclick="getrfq2awardlist('all',1)" /></span></h2></div>
                ...
                <table width="100%" border="0" cellspacing="5" class="black" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btllbl" style="textarea-decoration:none;" onclick="getrfq2awardlist('srch',1)"><b>{$LBL_SEARCH}</b></a>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <table width="100%" border="0" class="black" cellspacing="0" cellpadding="0">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="95" height="27" align="left">&nbsp;
                                            ...
                                            {/if*}
                                            <a href="javascript:getrfq2awardlist('all','1','rfq2.vRFQ2Code')"><strong>{$LBL_RFQ2_CODE}</strong></a>
                                        </td>
                                        <td width="95" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vInvoiceCode')"><strong>{$LBL_INV_CODE}</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vInvoiceCode')"><strong>{$LBL_AMOUNT}</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','vProductName')"><strong>{$LBL_PRODUCT}</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vBuyerName')"><strong>{$LBL_BUYER}</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vSupplierName')"><strong>{$LBL_SUPPLIER}</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','org.vCompanyName')"><strong>{$LBL_BUYER2}</strong></a></td>
                                        <td width="40" align="center"><a href="javascript:getrfq2awardlist('all','1','rfq2.eAuctionType')"><strong>{$LBL_TYPE}</strong></a></td>
                                        <td width="30" align="center"><a href="javascript:getrfq2awardlist('all','1','rfq2.eBidCriteria')"><strong>{$LBL_CRITERIA}</strong></a></td>
                                        <td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','r2bd.dBidDate')"><strong>{$LBL_BID} {$LBL_DATE}</strong></a></td>
                                        {*<td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','rdays,rtime')"><strong>{$LBL_TIME_LEFT}</strong></a></td>*}
                                        <td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','r2bd.fBidAdvanceTotal,r2bd.fBidPriceTotal')"><strong>{$LBL_BID} {$LBL_AMOUNT}</strong></a></td>
                                        {*<td width="63" align="center"><a href="javascript:getrfq2awardlist('all','1','rfq2.fTotalBids')"><strong>{$LBL_TOTAL_BIDS}</strong></a></td>*}
                                        <td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','r2aw.eStatus')"><strong>{$LBL_STATUS}</strong></a></td>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" name="awardmsg" id="awardmsg" value="{$awmsg}" />
    ...
    <script type="text/javascript" src="{$SITE_JS_AJAX}jlistrfq2award.js"></script>
    {literal}
