...
<div id="top-part">
	<div class="logo">
      <a href="#"><img src="{$SITE_IMAGES}logo.gif" alt="" align="left" /></a>
	...
	<div class="tab-bottline">
		...
		<ul id="top-navi">
			...
			{*<li><a href="{$SITE_URL_DUM}b2rfq2bidlist" class="{if $file|strpos:'b2rfq2bidlist' neq false || $file|strpos:'po' neq false}current{/if}"><em>{$LBL_RFQ2} {$LBL_BIDS}</em></a></li>
			<li><a href="{$SITE_URL_DUM}b2rfq2awardlist" class="{if $currentUrl eq $SITE_URL_DUM|cat:'b2rfq2awardlist'}current{/if}"><em>{$LBL_RFQ2} {$LBL_AWARD}</em></a></li>*}
		</ul>
	</div>
</div>
</form>
