<?php /* Smarty version 2.6.0, created on 2012-05-31 15:21:42
         compiled from member/organization/b2bprodtasoclist.tpl */ ?>
...
<div class="inner-white-bg">
 ...
 : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2bprdtassoclist('all',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
      </div>
...
2 :</td>
 ...
 :</td>
               <td width="30%" colspan="3" align="left">
                  ...
                  <a class="btllbl" onclick="getb2bprdtassoclist('srch',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
               </td>
            </tr>
         </table>
   ...
   <div>
      <div style="height:25px; padding-right:10px;" align="right">
			<?php if (( $this->_tpl_vars['uorg_type'] == 'Buyer2' && $this->_tpl_vars['sess_usertype_short'] == 'OA' ) || $this->_tpl_vars['sess_usertype_short'] == 'SM'): ?> 				<span class="btllbl" style="float:left;"><a href="<?php echo $this->_tpl_vars['SITE_URL_DUM']; ?>
b2bprodtasoc" style="textarea-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_CREATE']; ?>
</b></a></span>
			<?php endif; ?>
               ...
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td width="20" height="26" align="center"><input type="checkbox" class="radib-btn" name="checkbox" id="checkbox" /></td>
				        <td width="100" align="left"><a href="javascript:getb2bprdtassoclist('all','1','vBuyer2')"><b><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
2</b></a></td>
				        <td width="80" align="left"><a href="javascript:getb2bprdtassoclist('all','1','vProduct')"><strong><?php echo $this->_tpl_vars['LBL_BPRODUCT']; ?>
</strong></a></td>
                    <td width="70" align="center"><a href="javascript:getb2bprdtassoclist('all','1','vACode')"><strong><?php echo $this->_tpl_vars['LBL_CODE']; ?>
</strong></a></td>
                    <td width="62" align="center"><a href="javascript:getb2bprdtassoclist('all','1','eStatus')"><strong><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
</strong></a></td>
