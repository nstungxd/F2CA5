<?php /* Smarty version 2.6.0, created on 2012-05-31 12:31:30
         compiled from member/user/invoicelist.tpl */ ?>
...
sm_images/btn-show-all.gif"  alt="" border="0" style="vertical-align:middle;" onclick="getgrouplist('all',1)" /></span></h2></div>
   <div class="inport-gray-bg">
      <table width="100%" border="0" cellspacing="5" class="black" cellpadding="0">
		<tr><td colspan="4" align="right"><span id="msg" class="msg" style="color:#ff0000;">                   </span></td></tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="fDate" class="input-rag" id="fDate" style="width:139px; vertical-align:middle;" />
          		  </td>
        <td>Invoice Date To :</td>
        <td><input type="text" name="tDate" class="input-rag" id="tDate" style="width:139px; vertical-align:middle;" />
          		  </td>
      </tr>
      <tr>
        <td>Status :</td>
...
invoicecreate"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
  ...
  <tr>
    <td class="listing-sky-blue"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <?php endif; ?>
        <td width="77" align="center"><a href="javascript:getgrouplist('all','1','CONCAT(ou.vFirstName,\' \',ou.vLastName)')"><strong>Buyers</strong></a></td>
