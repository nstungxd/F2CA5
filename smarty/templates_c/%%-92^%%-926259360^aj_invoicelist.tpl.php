<?php /* Smarty version 2.6.0, created on 2012-05-31 12:31:31
         compiled from member/user/aj_invoicelist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/user/aj_invoicelist.tpl', 4, false),array('modifier', 'str_replace', 'member/user/aj_invoicelist.tpl', 13, false),array('modifier', 'calcLTzTime', 'member/user/aj_invoicelist.tpl', 19, false),array('modifier', 'DateTime', 'member/user/aj_invoicelist.tpl', 19, false),array('modifier', 'trim', 'member/user/aj_invoicelist.tpl', 23, false),array('modifier', 'htmlentities', 'member/user/aj_invoicelist.tpl', 36, false),array('modifier', 'cat', 'member/user/aj_invoicelist.tpl', 43, false),)), $this); ?>
...
" />
        ...
        <td width="58" align="center">
				...
				<?php else: ?>
					...
					<?php elseif ($this->_tpl_vars['activegroup'][$this->_sections['i']['index']]['iBuyerOrganizationID'] == $this->_tpl_vars['curORGID'] && $this->_tpl_vars['activegroup'][$this->_sections['i']['index']]['iStatusID'] == $this->_tpl_vars['isusts'] && $this->_tpl_vars['activegroup'][$this->_sections['i']['index']]['iaStatusID'] == 0): ?>
