<?php /* Smarty version 2.6.0, created on 2015-06-26 14:23:44
         compiled from member/user/b2rfq2bidlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ucfirst', 'member/user/b2rfq2bidlist.tpl', 54, false),)), $this); ?>
                            ...
                            <td class="listing-sky-blue">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="100" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong><?php echo $this->_tpl_vars['LBL_INV_CODE']; ?>
</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong><?php echo $this->_tpl_vars['LBL_AMOUNT']; ?>
</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2bidlist('all','1','vProductName')"><strong><?php echo $this->_tpl_vars['LBL_PRODUCT']; ?>
</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vBuyerName')"><strong><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
</strong></a></td>
                                        <td width="90" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vSupplierName')"><strong><?php echo $this->_tpl_vars['LBL_SUPPLIER']; ?>
</strong></a></td>
...
" />
                                <input type="hidden" name="chkbidstatus" id="chkbidstatus" value="<?php echo $this->_tpl_vars['chkbidstatus']; ?>
" />
