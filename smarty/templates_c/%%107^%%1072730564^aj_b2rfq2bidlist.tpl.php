<?php /* Smarty version 2.6.0, created on 2015-06-26 14:23:45
         compiled from member/user/aj_b2rfq2bidlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/user/aj_b2rfq2bidlist.tpl', 4, false),array('modifier', 'substr', 'member/user/aj_b2rfq2bidlist.tpl', 20, false),array('modifier', 'strtoupper', 'member/user/aj_b2rfq2bidlist.tpl', 20, false),array('modifier', 'calcLTzTime', 'member/user/aj_b2rfq2bidlist.tpl', 22, false),array('modifier', 'DateTime', 'member/user/aj_b2rfq2bidlist.tpl', 22, false),array('modifier', 'number_format', 'member/user/aj_b2rfq2bidlist.tpl', 24, false),)), $this); ?>
...
">
      <td width="95" height="27" align="left">&nbsp;
		...
		<td width="95" align="left"><?php echo $this->_tpl_vars['dtls'][$this->_sections['i']['index']]['vInvoiceCode']; ?>
</td>
...
, P:<?php echo ((is_array($_tmp=$this->_tpl_vars['dtls'][$this->_sections['i']['index']]['fBidPriceTotal'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, '.', ',') : number_format($_tmp, 2, '.', ',')); ?>
      ...
      <td width="50" align="center">
			<?php if ($this->_tpl_vars['dtls'][$this->_sections['i']['index']]['eSaved'] == 'Yes' && $this->_tpl_vars['dtls'][$this->_sections['i']['index']]['rfq2Status'] == 'Live'): ?>
...
sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a>&nbsp;
			<?php else: ?>
			<a href="<?php echo $this->_tpl_vars['SITE_URL_DUM']; ?>
viewsrfq2bid/<?php echo $this->_tpl_vars['dtls'][$this->_sections['i']['index']]['iBidId']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a>&nbsp;
			<?php endif; ?>
        </td>
