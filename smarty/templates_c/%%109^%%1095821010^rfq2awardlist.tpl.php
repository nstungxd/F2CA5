<?php /* Smarty version 2.6.0, created on 2015-06-20 22:24:17
         compiled from member/user/rfq2awardlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ucfirst', 'member/user/rfq2awardlist.tpl', 44, false),)), $this); ?>
...
sm_images/btn-show-all.gif"  alt="" border="0" style="vertical-align:middle;" onclick="getrfq2awardlist('all',1)" /></span></h2></div>
 ...
 :</td>
                        <td><input type="text" name="supplier" class="input-rag" id="supplier" style="width:188px;" /></td>
                                        ...
                                        <tr>
                        <td><?php echo $this->_tpl_vars['LBL_DATE']; ?>
 ...
 :</td>
                        ...
                        <td><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
 :</td>
 ...
 : </td>
                        ...
                        <td><?php echo $this->_tpl_vars['LBL_BUYER2']; ?>
 :</td>
                        <td>
                            <input type="text" name="buyer2" class="input-rag" id="buyer2" style="width:188px;" />
                            <a class="btllbl" style="textarea-decoration:none;" onclick="getrfq2awardlist('srch',1)"><b><?php echo $this->_tpl_vars['LBL_SEARCH']; ?>
</b></a>
                        </td>
                    </tr>
                </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="95" height="27" align="left">&nbsp;
                                                                                        <a href="javascript:getrfq2awardlist('all','1','rfq2.vRFQ2Code')"><strong><?php echo $this->_tpl_vars['LBL_RFQ2_CODE']; ?>
</strong></a>
                                        </td>
                                        <td width="95" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vInvoiceCode')"><strong><?php echo $this->_tpl_vars['LBL_INV_CODE']; ?>
</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vInvoiceCode')"><strong><?php echo $this->_tpl_vars['LBL_AMOUNT']; ?>
</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','vProductName')"><strong><?php echo $this->_tpl_vars['LBL_PRODUCT']; ?>
</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vBuyerName')"><strong><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','ioh.vSupplierName')"><strong><?php echo $this->_tpl_vars['LBL_SUPPLIER']; ?>
</strong></a></td>
                                        <td width="70" align="left"><a href="javascript:getrfq2awardlist('all','1','org.vCompanyName')"><strong><?php echo $this->_tpl_vars['LBL_BUYER2']; ?>
</strong></a></td>
                                        <td width="40" align="center"><a href="javascript:getrfq2awardlist('all','1','rfq2.eAuctionType')"><strong><?php echo $this->_tpl_vars['LBL_TYPE']; ?>
</strong></a></td>
                                        <td width="30" align="center"><a href="javascript:getrfq2awardlist('all','1','rfq2.eBidCriteria')"><strong><?php echo $this->_tpl_vars['LBL_CRITERIA']; ?>
</strong></a></td>
                                        <td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','r2bd.dBidDate')"><strong><?php echo $this->_tpl_vars['LBL_BID']; ?>
 <?php echo $this->_tpl_vars['LBL_DATE']; ?>
</strong></a></td>
                                                                                <td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','r2bd.fBidAdvanceTotal,r2bd.fBidPriceTotal')"><strong><?php echo $this->_tpl_vars['LBL_BID']; ?>
 <?php echo $this->_tpl_vars['LBL_AMOUNT']; ?>
</strong></a></td>
                                                                                <td width="70" align="center"><a href="javascript:getrfq2awardlist('all','1','r2aw.eStatus')"><strong><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
</strong></a></td>
...
" />
                                <input type="hidden" name="awardmsg" id="awardmsg" value="<?php echo $this->_tpl_vars['awmsg']; ?>
" />
