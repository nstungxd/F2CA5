<?php /* Smarty version 2.6.0, created on 2015-06-26 13:34:59
         compiled from member/user/rfq2rlist.tpl */ ?>
...
sm_images/btn-show-all.gif"  alt="" border="0" style="vertical-align:middle;" onclick="getrfq2list('all',1)" /></span></h2></div>
 ...
 : </td>
			<td>
				<?php echo $this->_tpl_vars['bidcriteria']; ?>
 &nbsp;&nbsp;&nbsp;
...
sm_images/progress.gif" alt=""/><a style="vertical-align:top;">Processing</a></span>
           <span id="dispmsg" class="msg"></span>
			  <span class="btllbl" style="float:right;"><b onclick="chstatus('deleteall','')"><?php echo $this->_tpl_vars['LBL_DELETE']; ?>
</b></span>
       </td>
     </tr>
   </table>
			...
			<tr>
			  <td width="100" height="27" align="left">&nbsp;
					...
					<a href="javascript:getrfq2list('all','1','rfq2.vRFQ2Code')"><strong><?php echo $this->_tpl_vars['LBL_RFQ2_CODE']; ?>
			  			  ...
			  			  <td width="100" align="left"><a href="javascript:getrfq2list('all','1','vProductName')"><strong><?php echo $this->_tpl_vars['LBL_PRODUCT']; ?>
</strong></a></td>
			  <td width="100" align="left"><a href="javascript:getrfq2list('all','1','ioh.vBuyerName')"><strong><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
</strong></a></td>
			  <td width="100" align="left"><a href="javascript:getrfq2list('all','1','ioh.vSupplierName')"><strong><?php echo $this->_tpl_vars['LBL_SUPPLIER']; ?>
</strong></a></td>
			  <td width="30" align="center"><a href="javascript:getrfq2list('all','1','rfq2.eAuctionType')"><strong><?php echo $this->_tpl_vars['LBL_TYPE']; ?>
</strong></a></td>
			  <td width="70" align="center"><a href="javascript:getrfq2list('all','1','rfq2.eBidCriteria')"><strong><?php echo $this->_tpl_vars['LBL_BID_CRITERIA']; ?>
</strong></a></td>
			  <td width="90" align="center"><a href="javascript:getrfq2list('all','1','rdays,rtime')"><strong><?php echo $this->_tpl_vars['LBL_TIME_LEFT']; ?>
</strong></a></td>
