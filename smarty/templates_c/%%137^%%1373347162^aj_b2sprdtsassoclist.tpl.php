<?php /* Smarty version 2.6.0, created on 2015-06-26 13:06:40
         compiled from member/organization/aj_b2sprdtsassoclist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/organization/aj_b2sprdtsassoclist.tpl', 4, false),)), $this); ?>
...
" />
      ...
      <td width="100" align="left" style="padding-left:2px;"><?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['vProduct']; ?>
</td>
      <td width="100" align="left" style="padding-left:2px;"><?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['vSupplier']; ?>
</td>
...
sm_images/icon-cancel.gif" alt="" border="0" />
	   ...
	   <td width="70" align="center">
			<?php if ($this->_tpl_vars['uorg_type'] == 'Buyer2' || $this->_tpl_vars['sess_usertype_short'] == 'SM'): ?>
			<a href="<?php echo $this->_tpl_vars['SITE_URL_DUM']; ?>
b2sprodtsasoc/<?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['iAssociationId']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			<?php endif; ?>
		   <a href="<?php echo $this->_tpl_vars['SITE_URL_DUM']; ?>
b2sprodtsasocview/<?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['iAssociationId']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
