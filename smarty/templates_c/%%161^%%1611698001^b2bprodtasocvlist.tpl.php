<?php /* Smarty version 2.6.0, created on 2015-06-22 09:24:47
         compiled from member/organization/b2bprodtasocvlist.tpl */ ?>
...
<div class="inner-white-bg">
 ...
 : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2bprdtassovlist('all',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
      </div>
...
2 :</td>
 ...
 :</td>
               <td width="30%" colspan="3" align="left">
                  ...
                  <a class="btllbl" onclick="getb2bprdtassovlist('srch',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
               </td>
            </tr>
         </table>
         ...
         <table width="100%" border="0" class="black" cellspacing="0" cellpadding="0">
            ...
            <td class="listing-sky-blue">
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
				        <td width="150" align="left"><a href="javascript:getb2bprdtassovlist('all','1','vBuyer2')">&nbsp;<b><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
2</b></a></td>
				        <td width="150" align="left"><a href="javascript:getb2bprdtassovlist('all','1','vProduct')"><b><?php echo $this->_tpl_vars['LBL_BPRODUCT']; ?>
</b></a></td>
                    <td width="70" align="center"><a href="javascript:getb2bprdtassovlist('all','1','vACode')"><b><?php echo $this->_tpl_vars['LBL_CODE']; ?>
</b></a></td>
                    <td width="70" align="center"><a href="javascript:getb2bprdtassovlist('all','1','eStatus')"><b><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
</b></a></td>
