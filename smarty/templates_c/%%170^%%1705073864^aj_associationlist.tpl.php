<?php /* Smarty version 2.6.0, created on 2015-06-23 18:11:00
         compiled from member/organization/aj_associationlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/organization/aj_associationlist.tpl', 4, false),)), $this); ?>
...
">
		<td width="20" height="26" align="center">
			<input type="checkbox" class="radib-btn" name="associations[]" id="iAsociationID" value="<?php echo $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['iAsociationID']; ?>
" />
		</td>
		<td width="100" align="center"><?php echo $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['vSupplierCode']; ?>
</td>
      <td width="80" align="left" style="padding-left:2px;"><?php echo $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['vBuyerOrg']; ?>
</td>
		...
		<td width="62" align="center">
			<?php if ($this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['eStatus'] == 'Need to Verify' || ( $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['eNeedToVerify'] == 'Yes' && $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['eStatus'] != 'Delete' )): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/exclaim.gif" alt="" border="0" />
         <?php elseif ($this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['eStatus'] == 'Active'): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
sm_images/icon-inactive.gif" alt="" border="0" />
			<?php elseif ($this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['eStatus'] == 'Delete'): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
createassociation/<?php echo $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['iAsociationID']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
sm_images/icon-edit.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			<img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-delete.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" onClick="Delete('delete','<?php echo $this->_tpl_vars['activegroup'][$this->_sections['ln']['index']]['iAsociationID']; ?>
')"/>
	  </td>
	</tr>
	<?php endfor; endif; ?>
