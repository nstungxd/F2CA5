<?php /* Smarty version 2.6.0, created on 2015-06-11 13:31:45
         compiled from member/user/aj_organizationuserlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/user/aj_organizationuserlist.tpl', 4, false),array('modifier', 'str_replace', 'member/user/aj_organizationuserlist.tpl', 18, false),)), $this); ?>
...
">
		<td width="30" height="26" align="center">
			<?php if ($this->_tpl_vars['sess_usertype_short'] == 'OA' && $this->_tpl_vars['iUserId'] == $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['iUserID']): ?>
				&nbsp;
			<?php else: ?>
...
" />
		...
		<td width="158" align="left" style="padding-left:2px;"><?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['vFirstName']; ?>
 <?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['vLastName']; ?>
      ...
      <td width="100" align="center" style="padding-left:2px;"><strong><?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['OrgName']; ?>
		...
		<td width="100" align="center"><?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['eUserType']; ?>
</td>
		<td width="80" align="center"><?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['vCountry']; ?>
</td>
		<td width="62" align="center">
			<?php if ($this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['eStatus'] == 'Active'): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon.gif" alt="" border="0" />
         <?php elseif ($this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['eStatus'] == 'Need to Verify'): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/exclaim.gif" alt="" border="0" />
         <?php elseif ($this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['eStatus'] == 'Modified'): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-modified.png" alt="" border="0" />
         <?php elseif ($this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['eStatus'] == 'Inactive'): ?>
            <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
organizationuserview/<?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['iUserID']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a>&nbsp;
			<?php else: ?>
			<a href="<?php echo $this->_tpl_vars['SITE_URL_DUM']; ?>
createorganizationuser/<?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['iUserID']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
sm_images/icon-edit.gif"  alt="" border="0" style="vertical-align:middle;" /></a> &nbsp;
			<img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-delete.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" onClick="Delete('delete','<?php echo $this->_tpl_vars['userlist'][$this->_sections['ln']['index']]['iUserID']; ?>
')" />
			<?php endif; ?>
	  </td>
	</tr>
