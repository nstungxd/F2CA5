<?php /* Smarty version 2.6.0, created on 2015-06-23 18:11:14
         compiled from member/organization/b2sprodtasoclist.tpl */ ?>
...
<div class="inner-white-bg">
 ...
 : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2sprdtassoclist('all',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
      </div>
...
2 :</td>
 ...
 :</td>
               <td width="30%" colspan="3" align="left">
                  ...
                  <a class="btllbl" onclick="getb2sprdtassoclist('srch',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
               </td>
            </tr>
         </table>
...
b2sprodtasoc" style="textarea-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_CREATE']; ?>
</b></a></span>
			<?php endif; ?>
               ...
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td width="20" height="26" align="center"><input type="checkbox" class="radib-btn" name="checkbox" id="checkbox" /></td>
				        <td width="100" align="left"><a href="javascript:getb2sprdtassoclist('all','1','vBuyer2')"><b><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
2</b></a></td>
				        <td width="80" align="left"><a href="javascript:getb2sprdtassoclist('all','1','vProduct')"><strong><?php echo $this->_tpl_vars['LBL_SPRODUCT']; ?>
</strong></a></td>
                    <td width="70" align="center"><a href="javascript:getb2sprdtassoclist('all','1','vACode')"><strong><?php echo $this->_tpl_vars['LBL_CODE']; ?>
</strong></a></td>
                    <td width="62" align="center"><a href="javascript:getb2sprdtassoclist('all','1','eStatus')"><strong><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
</strong></a></td>
