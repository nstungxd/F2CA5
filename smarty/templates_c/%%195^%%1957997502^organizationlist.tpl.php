<?php /* Smarty version 2.6.0, created on 2015-06-22 09:12:00
         compiled from member/organization/organizationlist.tpl */ ?>
<div class="middle-container">
<h1><span class=""><?php echo $this->_tpl_vars['LBL_ORG_LIST']; ?>
...
sm_images/btn-go.gif"  alt=""  style="cursor: pointer; vertical-align:middle;border:none;background: #f8f8f8;" onclick="getorglist('all',1)" />
      </div>
...
"><?php echo $this->_tpl_vars['countries'][$this->_sections['i']['index']]['vCountry']; ?>
                  ...
                  &nbsp; <input type="image" src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/btn-go.gif" alt=""   style="cursor: pointer; vertical-align:middle;border:none;background: #f8f8f8;" onclick="getorglist('srch',1)" />
               </td>
            </tr>
         </table>
      </div>
