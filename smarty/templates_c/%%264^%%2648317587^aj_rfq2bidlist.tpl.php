<?php /* Smarty version 2.6.0, created on 2015-06-24 07:42:18
         compiled from member/user/aj_rfq2bidlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/user/aj_rfq2bidlist.tpl', 4, false),array('modifier', 'substr', 'member/user/aj_rfq2bidlist.tpl', 21, false),array('modifier', 'strtoupper', 'member/user/aj_rfq2bidlist.tpl', 21, false),array('modifier', 'calcLTzTime', 'member/user/aj_rfq2bidlist.tpl', 23, false),array('modifier', 'DateTime', 'member/user/aj_rfq2bidlist.tpl', 23, false),array('modifier', 'number_format', 'member/user/aj_rfq2bidlist.tpl', 25, false),)), $this); ?>
...
, P:<?php echo ((is_array($_tmp=$this->_tpl_vars['dtls'][$this->_sections['i']['index']]['fBidPriceTotal'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 2, '.', ',') : number_format($_tmp, 2, '.', ',')); ?>
			...
			<?php elseif ($this->_tpl_vars['dtls'][$this->_sections['i']['index']]['eStatus'] == 'current'): ?>
				<?php echo $this->_tpl_vars['LBL_BEST']; ?>

			<?php elseif ($this->_tpl_vars['dtls'][$this->_sections['i']['index']]['eStatus'] == 'outbidded'): ?>
				<?php echo $this->_tpl_vars['LBL_OUTBIDDED']; ?>
...
rfq2bidview/<?php echo $this->_tpl_vars['dtls'][$this->_sections['i']['index']]['iBidId']; ?>
