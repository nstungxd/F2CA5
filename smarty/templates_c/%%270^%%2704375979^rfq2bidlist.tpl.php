<?php /* Smarty version 2.6.0, created on 2015-06-24 07:42:17
         compiled from member/user/rfq2bidlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ucfirst', 'member/user/rfq2bidlist.tpl', 45, false),)), $this); ?>
<div class="middle-container">
<h1><span class=""><?php echo $this->_tpl_vars['LBL_RFQ2']; ?>
 <?php echo $this->_tpl_vars['LBL_BID']; ?>
...
sm_images/btn-show-all.gif"  alt="" border="0" style="vertical-align:middle;" onclick="getrfq2bidlist('all',1)" /></span></h2></div>
 ...
 :</td>
			<td>
				...
				<a class="btllbl" style="textarea-decoration:none;" onclick="getrfq2bidlist('srch',1)"><b><?php echo $this->_tpl_vars['LBL_SEARCH']; ?>
</b></a>
			</td>
		</tr>
      </table>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  <td width="95" height="27" align="left">&nbsp;
										<a href="javascript:getrfq2bidlist('all','1','rfq2.vRFQ2Code')"><strong><?php echo $this->_tpl_vars['LBL_RFQ2_CODE']; ?>
</strong></a>
			  </td>
			  <td width="95" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong><?php echo $this->_tpl_vars['LBL_INV_CODE']; ?>
</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vInvoiceCode')"><strong><?php echo $this->_tpl_vars['LBL_AMOUNT']; ?>
</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','vProductName')"><strong><?php echo $this->_tpl_vars['LBL_PRODUCT']; ?>
</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vBuyerName')"><strong><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','ioh.vSupplierName')"><strong><?php echo $this->_tpl_vars['LBL_SUPPLIER']; ?>
</strong></a></td>
			  <td width="70" align="left"><a href="javascript:getrfq2bidlist('all','1','org.vCompanyName')"><strong><?php echo $this->_tpl_vars['LBL_BUYER2']; ?>
</strong></a></td>
			  <td width="40" align="center"><a href="javascript:getrfq2bidlist('all','1','rfq2.eAuctionType')"><strong><?php echo $this->_tpl_vars['LBL_TYPE']; ?>
</strong></a></td>
			  <td width="30" align="center"><a href="javascript:getrfq2bidlist('all','1','rfq2.eBidCriteria')"><strong><?php echo $this->_tpl_vars['LBL_CRITERIA']; ?>
</strong></a></td>
			  <td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','r2bd.dBidDate')"><strong><?php echo $this->_tpl_vars['LBL_BID']; ?>
 <?php echo $this->_tpl_vars['LBL_DATE']; ?>
</strong></a></td>
			  			  <td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','r2bd.fBidAdvanceTotal,r2bd.fBidPriceTotal')"><strong><?php echo $this->_tpl_vars['LBL_BID']; ?>
 <?php echo $this->_tpl_vars['LBL_AMOUNT']; ?>
</strong></a></td>
			  			  <td width="70" align="center"><a href="javascript:getrfq2bidlist('all','1','r2bd.eStatus')"><strong><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
</strong></a></td>
