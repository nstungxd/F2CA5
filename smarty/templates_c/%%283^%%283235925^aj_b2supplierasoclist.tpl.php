<?php /* Smarty version 2.6.0, created on 2012-05-31 12:48:16
         compiled from member/organization/aj_b2supplierasoclist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/organization/aj_b2supplierasoclist.tpl', 4, false),)), $this); ?>
...
" />
      ...
      <td width="80" align="left" style="padding-left:2px;"><?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['vSupplier']; ?>
</td>
...
b2supplierasoc/<?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['iAssociationId']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-pen.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			<?php endif; ?>
		   <a href="<?php echo $this->_tpl_vars['SITE_URL_DUM']; ?>
b2supplierasocview/<?php echo $this->_tpl_vars['asocs'][$this->_sections['ln']['index']]['iAssociationId']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
