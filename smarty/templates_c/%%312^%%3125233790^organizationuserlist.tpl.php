<?php /* Smarty version 2.6.0, created on 2015-06-20 22:23:15
         compiled from member/user/organizationuserlist.tpl */ ?>
...
sm_images/btn-go.gif"  alt="" border="0" style="cursor: pointer; vertical-align:middle;border: none;background: #f8f8f8;" onclick="getuserlist('all',1)" />
      </div>
...
btn-active-inactive.gif"  alt="" border="0" style="cursor:pointer;padding-right: 5px;vertical-align:top;" onclick="Delete('status','')"/>
             <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/btn-delete-all.gif" alt="" border="0" style="cursor:pointer;border: none; padding-right: 5px;vertical-align:top;" onClick="Delete('deleteall','')" /></div>
...
<input type="hidden" name="slfor" id="slfor" value="<?php echo $this->_tpl_vars['srchfor']; ?>
" />
...
jlistusers.js" async="async"></script>
<?php echo '
