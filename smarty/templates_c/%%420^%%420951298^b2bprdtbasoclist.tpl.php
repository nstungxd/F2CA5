<?php /* Smarty version 2.6.0, created on 2015-06-22 09:12:33
         compiled from member/organization/b2bprdtbasoclist.tpl */ ?>
...
<div class="inner-white-bg">
 ...
 : &nbsp; &nbsp; &nbsp; &nbsp;
         ...
         <a class="btllbl" onclick="getb2bprdtbassoclist('all',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a>
      </div>
...
2 :</td>
               ...
               <td width="25%"><?php echo $this->_tpl_vars['LBL_BPRODUCT']; ?>
 :</td>
               <td width="25%" align="left">
                  <span class="import-border">
 ...
 :</td>
            ...
            <tr><td colspan="4" align="right" style="padding-right:35px;"><a class="btllbl" onclick="getb2bprdtbassoclist('srch',1)" style="height:19px; text-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_GO']; ?>
</b></a></td></tr>
         </table>
      </div>
   </div>
...
b2bprodtbasoc" style="textarea-decoration:none;"><b><?php echo $this->_tpl_vars['LBL_CREATE']; ?>
</b></a></span>
			<?php endif; ?>
               ...
               <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr>
                    <td width="10" height="26" align="center"><input type="checkbox" class="radib-btn" name="checkbox" id="checkbox" /></td>
				        <td width="100" align="left"><a href="javascript:getb2bprdtbassoclist('all','1','vBuyer2')"><b><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
2</b></a></td>
				        <td width="100" align="left"><a href="javascript:getb2bprdtbassoclist('all','1','vProduct')"><strong><?php echo $this->_tpl_vars['LBL_BPRODUCT']; ?>
</strong></a></td>
                    <td width="100" align="left"><a href="javascript:getb2bprdtbassoclist('all','1','vBuyer')"><b><?php echo $this->_tpl_vars['LBL_BUYER']; ?>
</b></a></td>
                    <td width="70" align="center"><a href="javascript:getb2bprdtbassoclist('all','1','vACode')"><strong><?php echo $this->_tpl_vars['LBL_CODE']; ?>
</strong></a></td>
                    <td width="30" align="center"><a href="javascript:getb2bprdtbassoclist('all','1','eStatus')"><strong><?php echo $this->_tpl_vars['LBL_STATUS']; ?>
</strong></a></td>
