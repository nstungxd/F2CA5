<?php /* Smarty version 2.6.0, created on 2015-06-20 22:53:12
         compiled from member/inbox.tpl */ ?>
...
<h1><span class=""><?php echo $this->_tpl_vars['LBL_INBOX']; ?>
...
<div class="inner-white-bg">
   <div>
      ...
      <div class="inport-gray-bg">
         ...
         <div style=" padding-top:2px;">
            <strong>From : </strong><input type="text" name="from" id="from" value="" style="width:139px;" /> &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <strong>To : </strong><input type="text" name="to" id="to" value="" style="width:139px;" /> &nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
sm_images/btn-delete-1.gif"  align="right" alt="" border="0" style="cursor:pointer;" onclick="Delete('deleteall','')"/>
      <span id="updating" style="display: none;float: right;padding-right:5px">
           <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/progress.gif" alt="" style="vertical-align:middle;" />&nbsp;Processing
          </span>
            ...
            <td class="listing-sky-blue">
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="158" align="left"><?php echo $this->_tpl_vars['LBL_SUBJECT']; ?>
</td>
                    <td width="119" align="center"><?php echo $this->_tpl_vars['LBL_DATE']; ?>
</td>
                  </tr>
               </table>
            </td>
