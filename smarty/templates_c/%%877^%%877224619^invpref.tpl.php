<?php /* Smarty version 2.6.0, created on 2015-06-22 13:06:19
         compiled from member/user/invpref.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'member/user/invpref.tpl', 39, false),)), $this); ?>
...
invoicecreate/<?php echo $this->_tpl_vars['iInvoiceID']; ?>
"><em><?php echo $this->_tpl_vars['LBL_INV_HEADER']; ?>
</em></a></li>
...
index.php?file=u-invpref_a"  method="post" enctype="multipart/form-data">
                        <input type="hidden" name="iInvoiceID" id="iInvoiceID" value="<?php echo $this->_tpl_vars['iInvoiceID']; ?>
" />
                        <input type="hidden" name="iInvID" id="iInvID" value="<?php echo $this->_tpl_vars['iInvoiceID']; ?>
" />
...
" />
                        ...
                        <table width="97%" border="0" align="center" cellpadding="0" cellspacing="5" class="black">
                            ...
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore" valign="top"><textarea name="Data[tSourcingDocument]" id="tSourcingDocument" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tSourcingDocument'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tGlobalAgreement]" id="tGlobalAgreement" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tGlobalAgreement'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tPaymentTerms]" id="tPaymentTerms" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tPaymentTerms'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tFOB]" id="tFOB" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tFOB'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tDeliveryTerms]" id="tDeliveryTerms" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tDeliveryTerms'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tShippingControl]" id="tShippingControl" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tShippingControl'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tConditionsForPayment]" id="tConditionsForPayment" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tConditionsForPayment'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tPenalties]" id="tPenalties" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tPenalties'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tSpecialInstruction]" id="tSpecialInstruction" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tSpecialInstruction'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td class="blue-ore"><textarea name="Data[tNote]" id="tNote" cols="100" rows="5"><?php echo ((is_array($_tmp=$this->_tpl_vars['ioprefdt'][0]['tNote'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea></td>
                            </tr>
                            <tr>
