<?php /* Smarty version 2.6.0, created on 2015-06-22 09:12:00
         compiled from member/organization/aj_organizationlist.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'member/organization/aj_organizationlist.tpl', 4, false),)), $this); ?>
...
">
		<td width="30" height="26" align="center">
			<input type="checkbox" class="radib-btn" name="organizations[]" id="iOrganizationID" value="<?php echo $this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['iOrganizationID']; ?>
" />
		</td>
		<td width="158" align="left"><?php echo $this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['vCompanyName']; ?>
</td>
		...
		<td align="center" width="62">
            <?php if ($this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['eStatus'] == 'Active'): ?>
               <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon.gif" alt="" border="0" />
            <?php elseif ($this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['eStatus'] == 'Need to Verify'): ?>
               <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/exclaim.gif" alt="" border="0" height="19" width="19" />            <?php elseif ($this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['eStatus'] == 'Modified'): ?>
               <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-modified.png" alt="" border="0" height="19" width="19" />
            <?php elseif ($this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['eStatus'] == 'Inactive'): ?>
               <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-inactive.gif" alt="" border="0" />
				<?php elseif ($this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['eStatus'] == 'Delete'): ?>
               <img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
createorganization/<?php echo $this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['iOrganizationID']; ?>
"><img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
...
sm_images/icon-edit.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" /></a> &nbsp;
			<img src="<?php echo $this->_tpl_vars['SITE_IMAGES']; ?>
sm_images/icon-delete.gif"  alt="" border="0" style="cursor:pointer; vertical-align:middle;" onClick="Delete('delete','<?php echo $this->_tpl_vars['orglist'][$this->_sections['ln']['index']]['iOrganizationID']; ?>
')"/>
	  </td>
	</tr>
	<?php endfor; endif; ?>
